...
:::note{title="説明"}
百分比横棒グラフは、各カテゴリの構成比関係を横方向に表示するシーンに適しており、X 軸はデータ構成比を百分比形式で表示します。
...
\- 少なくとも 1 個ディメンションフィールド和1個メジャーフィールド
...
:::note{title="説明"}
百分比横棒グラフは、各カテゴリデータの構成比関係を横方向の百分比形式で表示します。
...
:::note{title="説明"}
データソースです。TidyData 仕様に準拠し、すでに集計済みのデータセットです。チャートのデータソースと構造を定義するために使用します。ユーザーが入力したデータセットに処理は不要です。VSeed は強力なデータ再形成機能を備えており、自動的にデータを再形成します。百分比横棒グラフのデータは最終的に 2 個のディメンション、1 個のメジャーへ変換されます。
...
:::note{title="説明"}
ディメンションです。最初のディメンションは Y 軸に配置されます。その他のディメンションはメジャー名（複数メジャーが存在する場合）と結合され、凡例項目として表示されます。
...
:::note{title="説明"}
メジャーです。メジャーは自動的に 1 つのメジャーに結合され、X 軸にマッピングされます。複数メジャーが存在する場合、メジャー名はその他のディメンションと結合され、凡例項目として表示されます。
...
横棒グラフのスタイル設定です。チャートの横棒グラフスタイルを定義するために使用し、横棒グラフの色、枠線、角丸などを含みます。
