...
時間の経過に伴うデータの傾向を表示するのに適しており、データポイントを線分で結んでトレンドラインを形成します。

適用シーン:

\- 複数のデータ系列の時間変化傾向を表示する

\- 異なるカテゴリの増加または減少のパターンを比較する

\- 時間ディメンション上でのデータの変動を観察する
...
\- X 軸は通常、時間軸またはカテゴリ軸で、ディメンション値を表示します

\- Y 軸は数値軸で、メジャー値を表示します

\- プレーヤーで時間ディメンションを制御し、折れ線が伸びていく過程を動的に表示できます
...
:::note{title="説明"}
動的折れ線グラフは、時間の経過に伴うデータの傾向を表示するのに適しています。
...
:::note{title="説明"}
プレーヤー設定です。時間ディメンションの指定に使用し、動的折れ線グラフの中核となる設定です。
...
:::note{title="説明"}
x 軸設定です。カテゴリ軸としてディメンション値を表示します。
