...
Ajouter une dimension de date agrégée par année
...
Regroupement mixte de dimensions ordinaires et de dimensions de date agrégées par trimestre
...
Mettre à jour la dimension de date existante à agréger par mois
