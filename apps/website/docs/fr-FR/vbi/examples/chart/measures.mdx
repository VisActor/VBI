...
Ajouter des métriques et définir l'encodage
...
Formatage des mesures : le volume des ventes utilise un format personnalisé de 10 000 yuans (préfixe ¥, en conservant 2 décimales), la marge bénéficiaire utilise un formatage automatique et les remises utilisent un format de pourcentage.
