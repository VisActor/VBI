...
Les cartes radar prennent en charge les canaux visuels suivants :
...
La carte radar, adaptée à l'analyse comparative de données multidimensionnelles, affiche la distribution numérique de chaque dimension via un système de coordonnées multi-axes

Scénarios applicables :

\- Comparaison complète des performances des données multidimensionnelles

\- Évaluation des performances de plusieurs objets sur plusieurs métriques

\- Affichage des fonctionnalités multidimensionnelles des données classifiées
...
\- La première dimension est utilisée comme chaque axe dimensionnel du graphique radar, et les autres dimensions sont utilisées comme différentes séries à des fins de comparaison.

\- Prend en charge plusieurs mesures à afficher sous forme de séries différentes

Fonctionnalités activées par défaut :

\- La légende, le système de coordonnées radar, les étiquettes de données, les informations d'infobulle et la mise à l'échelle numérique sont activés par défaut.
...
Graphique radar, montrant la relation de comparaison de données multidimensionnelles via un système de coordonnées multi-axes
...
La première dimension du graphique radar est mappée sur l'axe de l'angle et les dimensions restantes sont fusionnées avec le nom de l'mesure (lorsqu'il y a plusieurs mesures) et affichées sous forme d'éléments de légende.
...
Les mesures de la carte radar seront automatiquement fusionnés en un seul mesure et mappés sur l'axe du rayon. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les autres dimensions et affiché sous forme d'élément de légende.
...
:::note{title="Description"}
S'il faut activer l'animation du graphique radar
...
:::note{title="Description"}
Paramètres d'animation du graphique radar
...
:::note{title="Description"}
Configuration de l'animation d'entrée de carte radar
...
:::note{title="Description"}
Effet d'entrée sur la carte radar, prenant en charge les animations radiales et de zoom
...
:::note{title="Description"}
Configuration de l'animation de mise à jour de la carte radar
...
:::note{title="Description"}
Effet de mise à jour du graphique radar, prenant en charge l'animation de croissance
...
:::note{title="Description"}
Configuration de l'animation de boucle de carte radar
...
:::note{title="Description"}
Configuration de l'animation de l'atmosphère de la carte radar
