...
Les graphiques Sunburst prennent en charge les canaux visuels suivants :
...
Le graphique Sunburst est utilisé pour afficher des données hiérarchiques et représente la valeur numérique à travers la zone du secteur.

Scénarios applicables :

\- Afficher la distribution proportionnelle des données à plusieurs niveaux

\- Accent sur les relations hiérarchiques et les proportions
...
\- Au moins 1 champ numérique (mesure) pour cartographier la zone
...
Graphique Sunburst, montrant la relation de proportion des données hiérarchiques
...
Configuration des mesures pour définir la taille (superficie) du secteur
