...
Convient pour afficher les changements de classement des données au fil du temps
...
:::note{title="Description"}
Graphique à barres dynamique, adapté à l'affichage du classement des données au fil du temps
...
\- player : prend en charge le mappage de plusieurs dimensions sur les canaux de lecture
...
:::note{title="Description"}
Configuration du lecteur, utilisée pour spécifier la dimension temporelle, la configuration de base des graphiques à barres dynamiques
...
:::note{title="Description"}
Configuration de tri, les graphiques à barres dynamiques doivent généralement être triés dynamiquement en fonction de valeurs numériques
...
:::note{title="Description"}
Configuration de l'axe X, qui est un axe numérique et affiche les valeurs des mesures
...
:::note{title="Description"}
La configuration de l'axe Y, qui est l'axe des catégories, affiche les valeurs des dimensions et les colonnes sont disposées verticalement.
...
:::note{title="Description"}
Configuration de la boîte d'infobulle horizontale
...
:::note{title="Description"}
Configuration du style de graphique à barres
...
:::note{title="Description"}
Ligne d'étiquette de valeur de dimension
