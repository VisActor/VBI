...
\- Configuration de terrain recommandée : mesures `2`, dimensions `2`
...
Les graphiques à deux axes prennent en charge les canaux visuels suivants :

`xAxis` : canal de l'axe x, prend en charge `plusieurs dimensions`, mappé sur l'axe x en fonction de la valeur de dimension

`primaryYAxis` : canal de l'axe y de l'axe principal, prend en charge `plusieurs mesures`, mappe les mesures sur l'axe principal

`secondaryYAxis` : canal de l'axe y de l'axe secondaire, prend en charge `plusieurs mesures`, mappe les mesures sur l'axe secondaire
...
Les graphiques à deux axes conviennent pour montrer la relation comparative entre deux mesures de grandeurs différentes ou d'unités différentes, y compris l'axe de coordonnées principal et l'axe de coordonnées secondaire.

Scénarios applicables :

\- Analyse comparative d'mesures de différentes ampleurs

\- Comparaison des tendances des mesures de corrélation

\- Les mesures composites tels que les valeurs numériques et les taux de croissance doivent être affichés en même temps

\- Prend en charge différents types de combinaisons de graphiques (tels que graphique en courbes + graphique à barres / graphique en courbes + graphique en aires / graphique en aires + graphique à barres)
...
\- Au moins 1 champ mesure (métrique)

\- Prend en charge les groupes d'mesures. Le premier groupe d'mesures sera placé sur l'axe de gauche (axe principal), et le deuxième groupe d'mesures sera placé sur l'axe de droite (axe secondaire).
...
\- Deux ensembles de champs d'mesures peuvent être mappés respectivement sur les axes Y gauche et droit, et tous les mesures d'un groupe d'mesures seront automatiquement fusionnés en un seul mesure.

Fonctionnalités activées par défaut :

\- Les axes, les légendes, les étiquettes de données et les informations d'infobulle sont activés par défaut.
...
:::note{title="Description"}
Graphique à deux axes, un graphique composite montrant la relation comparative entre deux mesures d'ampleurs différentes
...
:::note{title="Description"}
L'ensemble de données, un ensemble de données conforme aux spécifications TidyData et agrégé, est utilisé pour définir la source de données et la structure du graphique. L'ensemble de données saisi par l'utilisateur ne nécessite aucun traitement. VSeed est livré avec une puissante fonction de remodelage des données et remodèlera les données par lui-même. Les données du graphique double axe seront éventuellement converties en 2 dimensions, 1 ou 2 mesures (selon que l'utilisateur a configuré un groupe d'mesures).

:::

**Exemple**
```ts
[{month:'Janvier', value:100, growth:0.2}, {month:'Février', value:150, growth:0.5}]
...
:::note{title="Description"}
Dimensions, la première dimension sera placée sur l'axe X et les dimensions restantes seront fusionnées avec le nom de l'mesure (lorsqu'il y a plusieurs mesures) et affichées sous forme d'éléments de légende.
...
:::note{title="Description"}
Mesure graphique à deux axes

Pour les mesures mappés aux axesYAxisprimaire etYAxissecondaire dans encoding,

Vous pouvez regrouper les mesures en définissant l'attribut `parentId`, et les mesures de différents groupes seront affichés dans différents sous-graphiques.

Vous pouvez également définir l'attribut `chartType` pour spécifier des types de graphiques pour différents groupes d'mesures.
...
\- primaryYAxis : L'axe y principal de la cartographie des mesures

\- secondaryYAxis : axe y secondaire de la cartographie des mesures
...
:::note{title="Description"}
Définissez le type de graphique de cet mesure dans les graphiques à deux axes, applicable uniquement aux graphiques à deux axes

\- line : Graphique en courbes

\- column : Graphique à barres

\- columnParallel : histogramme parallèle

\- columnPercent : histogramme de pourcentage

\- area : graphique en aires

\- areaPercent : Graphique en aires en pourcentage
...
:::note{title="Description"}
Utilisé pour définir si les échelles des deux axes d'un graphique à deux axes sont alignées. Lorsque measures a plusieurs groupes, alignTicks peut être configuré sous forme de tableau, et chaque élément correspond à l'alignement ou non des échelles d'un graphique à deux axes.
...
:::note{title="Description"}
La configuration de l'axe Y principal du graphique à deux axes est utilisée pour définir l'axe Y principal du graphique à deux axes, y compris la position, le style, etc. de l'axe Y principal. Lorsque measures comporte plusieurs groupes, PrimaryYAxis peut être configuré sous forme de tableau, chaque élément correspondant à l'axe Y principal d'un graphique à deux axes.
...
:::note{title="Description"}
La configuration de l'axe Y secondaire du graphique à deux axes est utilisée pour définir l'axe Y secondaire du graphique à deux axes, y compris la position, le style, etc. de l'axe Y secondaire. Lorsque measures comporte plusieurs groupes, l'axeYsecondaire peut être configuré sous forme de tableau, chaque élément correspondant à l'axe Y secondaire d'un graphique à deux axes.
...
:::note{title="Description"}
La couleur d'arrière-plan du graphique. La couleur d'arrière-plan peut être une chaîne de couleur, telle que 'red', 'blue' ou hexadécimal, rgb ou rgba '#ff0000', 'rgba(255,0,0,0.5)'
...
:::note{title="Description"}
Dans la même catégorie, la distance entre les piliers peut être une valeur en pixel ou une chaîne de pourcentage.
...
:::note{title="Description"}
Style primitif rectangulaire



Configuration du style de graphique à barres, utilisée pour définir le style de graphique à barres du graphique, y compris la couleur du graphique à barres, la bordure, les coins arrondis, etc.
...
:::note{title="Description"}
Style primitif de ligne



Configuration du style primitif de ligne, utilisée pour définir le style primitif de ligne du graphique, y compris la couleur, la transparence, la courbe, etc.
...
:::note{title="Description"}
Le segment de ligne est-il visible ?
...
:::note{title="Description"}
Le segment de ligne est-il lisse ?
...
:::note{title="Description"}
Transparence des couleurs des segments de ligne
...
:::note{title="Description"}
Style primitif de points



La configuration du style de primitive de point est utilisée pour définir le style de primitive de point du graphique, y compris la couleur, la bordure, etc. de la primitive de point.
...
:::note{title="Description"}
Style primitif de la zone



La configuration du style primitif de zone est utilisée pour définir le style primitif de zone du graphique, y compris la couleur, la transparence, la bordure, etc. de la primitive de zone.
...
:::note{title="Description"}
Si la primitive de zone est visible
...
:::note{title="Description"}
Couleur des primitives de zone
...
:::note{title="Description"}
Transparence des couleurs des primitives de zone
...
:::note{title="Description"}
La configuration de l'internationalisation, la configuration du langage du graphique, prend en charge 'zh\-CN' et 'en\-US'. De plus, vous pouvez appeler la méthode intl.setLocale('zh\-CN') pour définir la langue
