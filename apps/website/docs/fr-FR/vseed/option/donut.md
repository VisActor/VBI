...
Les graphiques en anneau prennent en charge les canaux visuels suivants :

`angle` : canal d'angle, prend en charge `plusieurs mesures`, mappé à l'angle du secteur en fonction de la valeur de l'mesure
...
Le graphique en anneau convient pour afficher la relation de proportion de données unidimensionnelles. Il y a une zone vide au centre pour afficher des informations récapitulatives.

Scénarios applicables :

\- Il est nécessaire d'afficher les données globales et la proportion de chaque partie en même temps

\- Mettre l'accent sur la relation entre l'ensemble et les parties des données

\- La zone centrale doit afficher des mesures clés ou des titres
...
\- Toutes les dimensions seront fusionnées avec le nom de l'mesure (lorsqu'il existe plusieurs mesures) et affichées sous forme d'éléments de légende.

\- Tous les mesures sont automatiquement fusionnés en un seul mesure

Fonctionnalités activées par défaut :

\- Les légendes, les étiquettes de données, les informations d'infobulle, les calculs de proportions et le texte central sont activés par défaut.
...
Diagramme en anneau, variation du diagramme circulaire avec un espace blanc au centre
...
Toutes les dimensions du graphique en anneau seront combinées avec le nom de l'mesure (lorsqu'il existe plusieurs mesures) en une seule dimension, mappées à l'angle du graphique en secteurs et affichées en tant qu'élément de légende.
...
Tous les mesures du graphique en anneau seront automatiquement fusionnés en un seul mesure, mappé au rayon du graphique en secteurs. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les dimensions restantes et affiché sous forme d'élément de légende.
