...
Les diagrammes circulaires prennent en charge les canaux visuels suivants :
...
Le diagramme circulaire convient pour afficher la relation de proportion entre des données unidimensionnelles. La proportion de chaque catégorie est représentée par la taille de la zone du secteur.

Scénarios applicables :

\- Afficher la distribution proportionnelle des données catégorielles

\- Mettre l'accent sur la relation entre l'ensemble et les parties des données

\- Analyse des proportions d'un petit nombre de catégories (pas plus de 6 recommandées)
...
Diagramme circulaire montrant la relation de proportion entre les données à dimension unique
...
Toutes les dimensions du diagramme circulaire seront combinées avec le nom de l'mesure (lorsqu'il existe plusieurs mesures) en une seule dimension, mappées à l'angle et affichées sous forme d'élément de légende.
...
Tous les mesures du diagramme circulaire seront automatiquement fusionnés en un seul mesure et mappés sur l’axe du rayon. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les dimensions restantes et affiché sous forme d'élément de légende.
