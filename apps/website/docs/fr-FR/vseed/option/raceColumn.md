...
Graphique à barres dynamique (Race Column Chart)

Convient pour afficher le classement des données dans le temps, avec des colonnes disposées verticalement

Scénarios applicables :

\- Lorsque le nom de la donnée est long

\- Il est nécessaire de comparer visuellement les tailles numériques des différentes catégories et d'afficher leurs évolutions au fil du temps.

\- Afficher la tendance de changement des données de séries chronologiques et mettre à jour dynamiquement le tri des colonnes
...
\- L'axe X est l'axe des catégories (données catégorielles), affichant les valeurs des dimensions

\- L'axe Y est un axe numérique (données continues), affichant les valeurs des mesures
...
\- Les colonnes sont triées dynamiquement en fonction de la valeur numérique pendant l'animation
...
:::note{title="Description"}
Histogramme dynamique, adapté à l'affichage du classement des données dans le temps
...
:::note{title="Description"}
Ensembles de données agrégées conformes aux TidyData
...
La première dimension est mappée sur le joueur et la deuxième dimension est mappée sur l'axe X.
...
Tous les mesures de l'histogramme dynamique seront automatiquement fusionnés en un seul mesure et mappés sur l'axe Y. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les autres dimensions et affiché sous forme d'élément de légende.
...
:::note{title="Description"}
La configuration du lecteur, utilisée pour spécifier la dimension temporelle, est la configuration de base des histogrammes dynamiques

Contrôlez la progression de la lecture dans la dimension temporelle via le lecteur pour obtenir des mises à jour dynamiques et trier les modifications des données.
...
:::note{title="Description"}
Configuration de tri, les histogrammes dynamiques doivent généralement être triés dynamiquement en fonction de valeurs numériques

Contrôle la manière dont les colonnes sont triées sur l'axe X
...
:::note{title="Description"}
Configuration des étiquettes pour afficher les étiquettes de données sur les colonnes
...
:::note{title="Description"}
La configuration de l'axe X, qui est l'axe des catégories, affiche les valeurs des dimensions et les colonnes sont disposées verticalement.
...
:::note{title="Description"}
Configuration de l'axe Y, qui est un axe numérique et affiche les valeurs des mesures
...
:::note{title="Description"}
Configuration du réticule pour afficher des valeurs précises de données
...
:::note{title="Description"}
Configuration du tri des légendes
...
:::note{title="Description"}
Configuration du style de colonne, qui peut être un style unique ou un tableau
...
:::note{title="Description"}
Ligne d'étiquette de valeur de dimension, ligne d'étiquette horizontale, marque la catégorie spécifique de l'axe Y
...
:::note{title="Description"}
La configuration des liaisons de dimensions prend en charge l'interaction des liaisons de dimensions entre plusieurs graphiques
