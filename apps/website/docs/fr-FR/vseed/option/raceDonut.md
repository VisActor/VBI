...
Graphique en anneau dynamique (Race Donut Chart)

Il convient pour afficher la relation de proportion des données dans le temps. Il y a une zone vide au centre pour afficher des informations récapitulatives.

Scénarios applicables :

\- Il est nécessaire d'afficher simultanément les données globales et l'évolution de la proportion de chaque partie au fil du temps.
...
\- Par rapport aux diagrammes circulaires, la zone centrale est laissée vide, ce qui est visuellement plus clair.
...
:::note{title="Description"}
Graphique en anneau dynamique, adapté pour montrer la relation de proportion entre les changements de données au fil du temps
...
:::note{title="Description"}
Configuration du joueur, utilisée pour spécifier la dimension temporelle, la configuration de base du graphique en anneau dynamique
