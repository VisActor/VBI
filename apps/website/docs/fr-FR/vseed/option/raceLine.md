...
Convient pour afficher la tendance des changements de données au fil du temps, en connectant des points de données via des segments de ligne pour former une ligne de tendance

Scénarios applicables :

\- Afficher les tendances de plusieurs séries de données au fil du temps

\- Comparez les modèles de croissance ou de déclin entre les catégories

\- Observer les fluctuations des données dans la dimension temporelle
...
\- L'axe X est généralement un axe de chronologie ou de catégorie, affichant les valeurs des dimensions

\- L'axe Y est un axe numérique affichant les valeurs des mesures.

\- Prend en charge le contrôle de la dimension temporelle via le lecteur et l'affichage dynamique du processus d'extension de la polyligne
...
:::note{title="Description"}
Graphique en courbes dynamique, adapté pour montrer la tendance des changements de données au fil du temps
...
:::note{title="Description"}
Configuration du lecteur, utilisée pour spécifier la dimension temporelle, la configuration de base des graphiques linéaires dynamiques
...
:::note{title="Description"}
Configuration de l'axe X, qui est l'axe des catégories et affiche les valeurs de dimension
...
:::note{title="Description"}
Configuration de la ligne d'infobulle verticale
...
:::note{title="Description"}
Configuration du tri sur l'axe X
...
:::note{title="Description"}
Configuration de style primitif de point
...
:::note{title="Description"}
Configuration du style primitif de ligne
...
:::note{title="Description"}
Configuration du point d'étiquetage
...
:::note{title="Description"}
Configuration de la ligne d'étiquette de valeur de dimension
...
:::note{title="Description"}
Configuration de la ligne d'étiquette numérique
...
:::note{title="Description"}
Configuration de la zone d'étiquette
...
:::note{title="Description"}
Configuration des liaisons de dimensions
