...
\- Configuration de terrain recommandée : `2` mesures, `1` dimensions
...
Le nuage de points convient pour afficher la distribution des données et représente la valeur des données à travers la position des points.

Scénarios applicables :

\- Analysez les caractéristiques de distribution des données, telles que la tendance centrale des données, la plage de distribution, les valeurs aberrantes, etc.
...
\- Au moins 2 champs numériques (mesures)

\- Le premier champ d'mesure sera placé sur l'axe X et les mesures restants seront fusionnés et mappés sur l'axe Y.

\- Les noms des mesures et des dimensions seront fusionnés et affichés sous forme d'éléments de légende.
...
La première dimension du nuage de points est mappée sur l'axe X et les dimensions restantes seront fusionnées avec le nom de l'mesure (lorsqu'il y a plusieurs mesures) et affichées sous forme d'éléments de légende.
...
:::note{title="Description"}
Mesure de diagramme de dispersion
...
[
  {
    id: 'profit', alias : 'Bénéfice', encoding : 'xAxis'
  },
  {
...
:::note{title="Description"}
S'il faut activer l'animation de nuage de points
...
:::note{title="Description"}
Configuration de l'animation d'entrée de diagramme de nuages ​​de points
...
:::note{title="Description"}
Effet d'entrée de diagramme de dispersion, prenant en charge la croissance et la mise à l'échelle des animations
...
:::note{title="Description"}
Effet de mise à jour du graphique à nuages ​​de points, prise en charge de l'animation de croissance
...
:::note{title="Description"}
Configuration de l'animation de boucle de nuage de points
...
:::note{title="Description"}
Effet de boucle de nuage de points
...
:::note{title="Description"}
Configuration de l'animation de l'atmosphère du nuage de points
...
Axe des valeurs, configuration de l'axe des x, utilisé pour définir l'axe des x du graphique, y compris la position, le format, le style, etc. de l'axe des x.
...
Les lignes d'étiquettes numériques (y compris la ligne moyenne, la ligne de valeur maximale, la ligne de valeur minimale, etc.) sont affichées dans le sens vertical. La position et le style de la ligne d'étiquette peuvent être définis. Si vous devez tracer des lignes d'étiquette correspondant à des valeurs telles que la ligne moyenne métrique de l'axe y, veuillez utiliser cette configuration.
...
Configuration de la ligne de régression linéaire, y compris le style de ligne de régression linéaire, etc.
...
:::note{title="Description"}
Niveau d'effet de flou graphique
...
:::note{title="Description"}
La couleur de l'ombre du graphique
...
:::note{title="Description"}
Distance de décalage horizontal de l'ombre
...
:::note{title="Description"}
Distance de décalage vertical de l'ombre
...
:::note{title="Description"}
Élément de configuration de la ligne de régression pondérée locale



Éléments de configuration de la ligne de régression pondérée locale, y compris le style de la ligne de régression pondérée locale, etc.
...
:::note{title="Description"}
droite de régression logistique



Configuration de la ligne de régression logistique, y compris le style de ligne de régression logistique, etc.
