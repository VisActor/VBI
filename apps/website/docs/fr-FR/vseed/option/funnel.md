...
Les graphiques en entonnoir prennent en charge les canaux visuels suivants :

`size` : taille du canal, prend en charge `plusieurs mesures`, mappé à la largeur de l'entonnoir en fonction de la valeur de l'mesure
...
Graphique en entonnoir, utilisé pour montrer la relation de proportion entre les données unidimensionnelles

Scénarios applicables :

Scénarios applicables du graphique en entonnoir :

\- Convient à l'analyse de processus comprenant plusieurs étapes consécutives et standardisées et à l'affichage clair de la perte ou de la conversion de données à chaque lien
...
\- Au moins 1 champ numérique (métrique)

\- Toutes les dimensions seront combinées avec le nom de l'mesure (lorsqu'il existe plusieurs mesures) en une seule dimension et affichées sous forme d'élément de légende.

\- Tous les mesures sont automatiquement fusionnés en un seul mesure

Fonctionnalités activées par défaut :

\- Les légendes, les étiquettes de données, les informations d'infobulle et les calculs de proportions sont activés par défaut.
...
Graphique en entonnoir, montrant la relation de proportion entre les données unidimensionnelles
...
Toutes les dimensions du graphique en entonnoir seront combinées avec le nom de l'mesure (lorsqu'il existe plusieurs mesures) en une seule dimension et affichées sous forme d'élément de légende.
...
Tous les mesures du graphique en entonnoir seront automatiquement fusionnés en un seul mesure. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les dimensions restantes et affiché sous forme d'élément de légende.
...
:::note{title="Description"}
Configuration des couleurs du dégradé linéaire, utilisée pour définir la palette de couleurs du graphique
...
:::note{title="Description"}
La configuration de la légende des couleurs est utilisée pour définir la légende du graphique, y compris l'emplacement, le format, le style, etc. de la légende.
