...
Les graphiques à barres côte à côte prennent en charge les canaux visuels suivants :

`yAxis` : canal de l'axe y, prend en charge `plusieurs dimensions`, mappé sur l'axe y en fonction de la valeur de dimension

`xAxis` : canal de l'axe x, prend en charge `plusieurs mesures`, mappé sur l'axe x en fonction de la valeur de l'mesure
...
Les graphiques à barres côte à côte conviennent aux scénarios de comparaison parallèle horizontale de plusieurs mesures. Plusieurs barres sont disposées en parallèle pour afficher différentes valeurs d'mesure.

Scénarios applicables :

\- Comparaison multi-métriques lorsque les noms de catégories sont longs

\- Comparaison horizontale où les classements et les valeurs sont affichés simultanément

\- Analyse côte à côte de données multidimensionnelles
...
:::note{title="Description"}
Graphique à barres côte à côte, adapté aux scénarios de comparaison horizontale parallèle multi-mesures
...
:::note{title="Description"}
La source de données, un ensemble de données agrégées conforme à la spécification TidyData, est utilisée pour définir la source de données et la structure du graphique. L'ensemble de données saisi par l'utilisateur ne nécessite aucun traitement. VSeed dispose d'une puissante fonction de remodelage des données et remodèlera les données par lui-même. Les données du graphique à barres côte à côte seront finalement converties en 2 dimensions et 1 mesure.
...
:::note{title="Description"}
Dimension, la première dimension est mappée sur l'axe Y et les dimensions restantes seront fusionnées avec le nom de l'mesure (lorsqu'il y a plusieurs mesures) et affichées sous forme d'éléments de légende.
...
:::note{title="Description"}
Les mesures, les mesures de graphique à barres côte à côte seront automatiquement fusionnés en un seul mesure et mappés sur l'axe X. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les autres dimensions et affiché sous forme d'élément de légende.

:::

**Exemple**
```ts
[{id : 'value1', alias : 'Mesure 1'}, {id : 'value2', alias : 'Mesure 2'}]
...
:::note{title="Description"}
La couleur d'arrière-plan du graphique, qui est par défaut un arrière-plan transparent. La couleur d'arrière-plan peut être une chaîne de couleur, telle que 'red', 'blue' ou hexadécimal, rgb ou rgba '#ff0000', 'rgba(255,0,0,0.5)'
...
:::note{title="Description"}
Axe des x, axe des valeurs, configuration de l'axe des x, utilisé pour définir l'axe des x du graphique, y compris la position, le format, le style, etc. de l'axe des x.
...
:::note{title="Description"}
axe y, axe des catégories, configuration de l'axe y, utilisé pour définir l'axe y du graphique, y compris la position, le format, le style, etc. de l'axe y.
...
:::note{title="Description"}
La configuration de la boîte d'infobulle horizontale est utilisée pour définir la boîte d'infobulle horizontale du graphique, y compris la couleur de la boîte d'infobulle horizontale, le style d'étiquette, etc.
...
:::note{title="Description"}
Graphique à barres avec coins arrondis empilés
...
:::note{title="Description"}
La hauteur maximale du rectangle, qui peut être une valeur en pixels ou une chaîne de pourcentage
...
:::note{title="Description"}
Dans la même catégorie, la distance entre les rectangles peut être une valeur en pixel ou une chaîne de pourcentage.
...
:::note{title="Description"}
Configuration de tri sur l'axe Y, prend en charge le tri selon des dimensions ou des mesures et un ordre de tri personnalisé
...
:::note{title="Description"}
Style primitif de rectangle, configuration du style de graphique à barres, utilisé pour définir le style de graphique à barres du graphique, y compris la couleur du graphique à barres, la bordure, les coins arrondis, etc.
...
:::note{title="Description"}
Les lignes d'étiquettes numériques (y compris la ligne moyenne, la ligne de valeur maximale, la ligne de valeur minimale, etc.) sont affichées dans le sens vertical. La position et le style de la ligne d'étiquette peuvent être définis. Si vous devez tracer des lignes d'étiquette correspondant à des valeurs telles que des lignes moyennes, veuillez utiliser cette configuration.
...
:::note{title="Description"}
La ligne d'étiquette de valeur de dimension, affichée horizontalement, peut définir la position, le style, etc. de la ligne d'étiquette
