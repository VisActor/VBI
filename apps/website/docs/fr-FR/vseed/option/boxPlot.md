...
Les boxplots prennent en charge les canaux visuels suivants :
...
Les boîtes à moustaches conviennent pour afficher la distribution des données. L'axe X est l'axe des catégories (données catégorielles), l'axe Y est l'axe numérique (données continues) et les cases sont disposées verticalement.
...
:::note{title="Description"}
La première dimension de la boîte à moustaches est mappée sur l'axe X et les dimensions restantes seront fusionnées avec le nom de l'mesure (lorsqu'il y a plusieurs mesures) et affichées sous forme d'éléments de légende.
...
:::note{title="Description"}
Tous les mesures du boxplot seront automatiquement fusionnés en un seul mesure et mappés sur l’axe Y. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les autres dimensions et affiché sous forme d'élément de légende.
...
\- value : Mesures correspondant à des valeurs discrètes, utilisés pour calculer des valeurs statistiques et afficher des boîtes à moustaches

\- q1 : Cartographie des mesures correspondant au 25ème quantile de la valeur statistique

\- q3 : cartographie des mesures correspondant au 75ème percentile de la valeur statistique

\- min : Cartographie des mesures du minimum de moustaches en boîte

\- max : Cartographie des mesures du maximum de moustaches en boîte

\- meadian : Cartographie des mesures de valeur statistique médiane

\- outliers : Cartographie des mesures des valeurs aberrantes
...
:::note{title="Description"}
La configuration de style de la boîte à moustaches prend en charge la granularité globale ou de sélecteur pour prendre effet.
...
:::note{title="Description"}
La primitive boxPlot est-elle visible ?
...
:::note{title="Description"}
transparence des couleurs primitives boxPlot
...
:::note{title="Description"}
Couleur de la bordure de l'élément boxPlot
...
:::note{title="Description"}
largeur de la bordure de l'élément boxPlot
...
:::note{title="Description"}
transparence de la bordure primitive boxPlot
...
:::note{title="Description"}
La couleur de la ligne médiane
...
:::note{title="Description"}
Couleur de la boîte et de la ligne des moustaches
...
:::note{title="Description"}
Configuration de style des points d'exception, prend en charge la granularité globale ou du sélecteur pour prendre effet
...
:::note{title="Description"}
Configuration de la longueur des moustaches pour l'histogramme, prend en charge les valeurs scalaires et les tableaux de longueur 2

Lorsque la valeur est un scalaire, utilisez whiskers * IQR pour calculer les limites supérieure et inférieure

Lorsque la valeur est un tableau à 2 éléments, whiskers[0] doit être compris entre [0, 0,25), indiquant que la valeur limite inférieure prend le centile correspondant ;

whiskers[1] doit être compris entre (0,75, 1], indiquant que la valeur limite supérieure prend le centile correspondant ;
...
:::note{title="Description"}
La largeur maximale du boxplot peut être définie en valeur absolue de pixel ou en pourcentage (par exemple « 10 %).
...
:::note{title="Description"}
L'espacement au sein de chaque groupe dans la boîte à moustaches groupée peut être défini sur une valeur absolue de pixel ou un pourcentage (tel que « 10 % »).
