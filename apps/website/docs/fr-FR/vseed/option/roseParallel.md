...
Les graphiques de roses groupées prennent en charge les canaux visuels suivants :
...
Graphique en roses groupées, adapté aux scénarios de comparaison de données multidimensionnelles, montrant la taille des données à travers l'arc sectoriel et le rayon dans le système de coordonnées polaires
...
:::note{title="Description"}
Tableau des roses groupées



Graphique en roses groupées, montrant la relation de comparaison de données multidimensionnelles via un système de coordonnées polaires
