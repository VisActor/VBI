...
Les graphiques à barres de pourcentage prennent en charge les canaux visuels suivants :
...
Graphique à barres de pourcentage, adapté aux scénarios dans lesquels la proportion de chaque catégorie est affichée horizontalement. L'axe X affiche la proportion de données sous forme de pourcentage.

Scénarios applicables :

\- Comparaison des proportions lorsque les noms de catégories sont plus longs

\- Analyse de composition horizontale de données multidimensionnelles

\- Scénario où le classement et la proportion sont affichés en même temps
...
\- Prend en charge l'empilement multi-séries pour afficher les relations proportionnelles
...
:::note{title="Description"}
Graphique à barres en pourcentage, montrant la relation entre la proportion de chaque catégorie de données sous forme de pourcentages horizontaux
...
:::note{title="Description"}
Dimensions, la première dimension sera placée sur l'axe Y et les dimensions restantes seront fusionnées avec le nom de l'mesure (lorsqu'il y a plusieurs mesures) et affichées sous forme d'éléments de légende.
...
:::note{title="Description"}
Les mesures seront automatiquement fusionnés en un seul mesure et mappés sur l’axe X. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les autres dimensions et affiché sous forme d'élément de légende.
...
:::note{title="Description"}
Étiqueter les lignes verticales
...
:::note{title="Description"}
Étiqueter les lignes horizontales
