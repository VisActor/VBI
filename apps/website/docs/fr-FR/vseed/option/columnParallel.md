...
L'histogramme côte à côte prend en charge les canaux visuels suivants :
...
Histogramme côte à côte, adapté aux scénarios de comparaison parallèle de plusieurs mesures. Plusieurs colonnes sont disposées côte à côte pour afficher différentes valeurs d’mesure.

Scénarios applicables :

\- Comparaison parallèle de plusieurs mesures dans la même dimension
...
\- Les légendes, les axes de coordonnées, les étiquettes de données, les informations d'infobulle et le tri des mesures sont activés par défaut.
...
:::note{title="Description"}
Histogramme côte à côte, adapté aux scénarios de comparaison parallèle multi-mesures
...
:::note{title="Description"}
Dimension, la première dimension est mappée sur l'axe X et les dimensions restantes seront fusionnées avec le nom de l'mesure (lorsqu'il y a plusieurs mesures) et affichées sous forme d'éléments de légende.
...
:::note{title="Description"}
Mesures, tous les mesures de l'histogramme côte à côte seront automatiquement fusionnés en un seul mesure et mappés sur l'axe Y. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les autres dimensions et affiché sous forme d'élément de légende.
...
:::note{title="Description"}
Style primitif de rectangle, configuration de style de graphique à colonnes parallèles, utilisé pour définir le style de graphique à colonnes parallèles du graphique, y compris la couleur, la bordure, les coins arrondis, etc. du graphique à colonnes parallèles.
