...
Graphique à barres en pourcentage, adapté aux scénarios montrant la relation de proportion entre diverses catégories. L'axe Y affiche la proportion de données sous forme de pourcentage.

Scénarios applicables :

\- Comparaison des proportions de différentes catégories de données

\- Analyse de la composition de données multidimensionnelles

\- La tendance de changement de proportion des séries chronologiques
...
:::note{title="Description"}
Graphique à barres de pourcentage



Graphique à barres en pourcentage, montrant la relation entre la proportion de chaque catégorie de données sous forme de pourcentages
...
Les mesures d'histogramme de pourcentage seront automatiquement fusionnés en un seul mesure et mappés sur l'axe Y. Lorsqu'il existe plusieurs mesures, les noms des mesures seront fusionnés avec les autres dimensions et affichés sous forme d'éléments de légende.
...
:::note{title="Description"}
Histogramme côte à côte Coins arrondis empilés
...
:::note{title="Description"}
Style primitif rectangulaire, utilisé pour définir le style primitif rectangulaire du graphique, y compris la couleur, la bordure, les coins arrondis, etc. de la primitive rectangulaire.
