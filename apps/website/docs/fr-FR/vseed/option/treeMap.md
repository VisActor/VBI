...
Le treemap rectangulaire prend en charge les canaux visuels suivants :
...
Diagramme en arbre rectangulaire, utilisé pour afficher des données hiérarchiques, exprimant la taille numérique à travers la taille de la zone rectangulaire
...
Diagramme en arbre rectangulaire, montrant la relation de proportion des données hiérarchiques
