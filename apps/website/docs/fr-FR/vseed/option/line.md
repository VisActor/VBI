...
Les graphiques linéaires prennent en charge les canaux visuels suivants :

`x` : canal de l'axe x, prend en charge `plusieurs dimensions`, mappé sur l'axe x en fonction de la valeur de dimension

`y` : canal de l'axe y, prend en charge `plusieurs mesures`, mappé sur l'axe y en fonction de la valeur de l'mesure
...
Les graphiques linéaires conviennent pour afficher la tendance des changements de données au fil du temps ou des catégories ordonnées. Les points de données sont reliés par des segments de ligne pour former une ligne de tendance.

Scénarios applicables :

\- Afficher les tendances dans les données de séries chronologiques

\- Comparez les tendances sur plusieurs séries de données

\- Analyser les modèles de croissance ou de déclin des données
...
\- Les légendes, les axes de coordonnées, les marqueurs de points de données, les infobulles et les lignes de tendance sont activés par défaut.
...
:::note{title="Description"}
Graphiques linéaires, adaptés pour afficher les tendances des données au fil du temps ou des catégories ordonnées
...
:::note{title="Description"}
Dimension : la première dimension du graphique en courbes est mappée sur l'axe X et les dimensions restantes seront fusionnées avec le nom de l'mesure (lorsque plusieurs mesures existent) et affichées sous forme d'éléments de légende.
...
:::note{title="Description"}
Mesures, tous les mesures du graphique en courbes seront automatiquement fusionnés en un seul mesure et mappés sur l'axe Y. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les autres dimensions et affiché sous forme d'élément de légende.
