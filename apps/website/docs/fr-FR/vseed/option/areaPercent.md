...
Les graphiques en aires en pourcentage prennent en charge les canaux visuels suivants :
...
Graphique en aires de pourcentage, adapté pour montrer la tendance des changements de proportion multi-catégories au fil du temps. L'axe Y montre la relation de proportion sous forme de pourcentage.

Scénarios applicables :

\- Analyse des changements de composition des séries chronologiques

\- Comparaison des tendances des proportions multicatégories

\- La proportion cumulée et la proportion d'une seule catégorie sont affichées en même temps
...
\- La première dimension sera placée sur l'axe Y et les dimensions restantes seront fusionnées avec le nom de l'mesure (lorsqu'il y a plusieurs mesures) et affichées sous forme d'éléments de légende.

\- Tous les mesures sont automatiquement fusionnés en un seul mesure

Fonctionnalités activées par défaut :

\- La légende, l'axe, l'étiquette de pourcentage, les informations d'infobulle et le calcul des proportions sont activés par défaut.
...
:::note{title="Description"}
Graphique de zone en pourcentage



Graphique en aires de pourcentage, montrant les changements dans la proportion de plusieurs catégories avec une certaine dimension sous forme de pourcentages
...
La première dimension est mappée sur l'axe X et les dimensions restantes sont combinées avec le nom de l'mesure (lorsqu'il existe plusieurs mesures) et affichées sous forme d'éléments de légende.

:::

**Exemple**
```ts
[{id : 'month', alias : 'mois' }, {id : 'year', alias : 'année' }]
...
Les mesures du graphique en aires de pourcentage seront automatiquement fusionnés en un seul mesure, mappé sur l'axe Y, et le nom de l'mesure sera fusionné avec les autres dimensions et affiché en tant qu'élément de légende.

:::

**Exemple**
```ts
[{id : 'value', alias : 'Rapport de valeur', format : 'percent'}]
...
Configuration de pagination, utilisée pour configurer la fonction de pagination des graphiques
...
:::note{title="Description"}
S'il faut activer l'animation des graphiques linéaires/aires
...
:::note{title="Description"}
Paramètres d'animation des graphiques linéaires/aires
...
:::note{title="Description"}
Configuration de l'animation d'entrée de graphique en courbes/zone
...
:::note{title="Description"}
Effet d'entrée de graphique en courbes/zone, prend en charge l'animation de chargement et de croissance
...
:::note{title="Description"}
Configuration de l'animation de mise à jour des graphiques linéaires/aires
...
:::note{title="Description"}
Effet de mise à jour du graphique en courbes/zone, prise en charge de l'animation de croissance
...
:::note{title="Description"}
Configuration de l'animation du cycle des graphiques linéaires/aires
...
:::note{title="Description"}
Effet de boucle de graphique en courbes/zones
...
:::note{title="Description"}
Configuration de l'animation de l'atmosphère d'un graphique en courbes/surface
...
Axe des catégories, configuration de l'axe des x, utilisé pour définir l'axe des x du graphique, y compris la position, le format, le style, etc. de l'axe des x.
...
Axe des valeurs, configuration de l'axe y, utilisé pour définir l'axe y du graphique, y compris la position, le format, le style, etc. de l'axe y.
...
:::note{title="Description"}
ligne de pointe verticale



Lorsque la souris est déplacée sur le graphique, la ligne d'infobulle verticale s'affiche
