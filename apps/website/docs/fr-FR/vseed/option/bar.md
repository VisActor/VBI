...
Les graphiques à barres prennent en charge les canaux visuels suivants :
...
Graphique à barres, adapté aux scénarios de comparaison horizontale de données. L'axe Y est l'axe des catégories (données catégorielles), l'axe X est l'axe numérique (données continues) et les colonnes sont disposées horizontalement.

Scénarios applicables :

\- Lorsque le nom de la donnée est long

\- Besoin d'afficher une comparaison de classement des données

\- Afficher les données bidirectionnelles positives et négatives
...
**Exemple**
```ts
[{id: "date", alias: "date"}, {id: "value", alias: "valeur numérique"}]
...
Les mesures et les mesures de graphique à barres seront automatiquement fusionnés en un seul mesure et mappés sur l'axe X. Lorsqu'il y a plusieurs mesures, le nom de l'mesure sera fusionné avec les autres dimensions et affiché sous forme d'élément de légende.
