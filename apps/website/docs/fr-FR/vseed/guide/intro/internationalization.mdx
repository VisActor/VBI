...
VSeed dispose d'une prise en charge intégrée de l'internationalisation et vous pouvez changer d'environnement linguistique (comme le chinois `zh-CN`, l'anglais `en-US`, etc.) en configurant `locale`.
