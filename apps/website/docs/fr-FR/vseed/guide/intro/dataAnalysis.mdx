...
## Tri des axes et tri des légendes

VSeed permet une configuration de tri pratique.

- `sort` : utilisé pour configurer les règles de tri des données d'axe, prenant en charge la spécification du champ de tri `orderBy` et l'ordre de tri `order`.
