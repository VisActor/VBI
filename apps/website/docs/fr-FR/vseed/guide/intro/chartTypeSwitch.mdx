...
VSeed prend en charge plusieurs types de graphiques et vous pouvez facilement basculer entre différentes formes de visualisation via les propriétés `chartType`, y compris les graphiques standards, les tableaux croisés dynamiques, etc.
