...
:::note{title="설명"}
동적 꺾은선 차트 (Race Line Chart)

데이터가 시간에 따라 변하는 추세를 표시하는 데 적합, 선분으로 데이터 포인트를 연결하여 추세선 형성

적용 시나리오:

\- 여러 데이터 시리즈의 시간에 따른 변화 추세 표시

\- 다른 카테고리의 증가 또는 감소 패턴 비교

\- 시간 차원에서 데이터의 변동 상황 관찰
...
\- X축은 일반적으로 시간 축 또는 카테고리 축으로 차원 값을 표시

\- Y축은 값 축으로 지표 값을 표시

\- 플레이어를 통해 시간 차원을 제어하고 꺾은선의 확장 과정을 동적으로 표시 지원
...
:::note{title="설명"}
동적 꺾은선 차트, 데이터가 시간에 따라 변하는 추세를 표시하는 데 적합
...
:::note{title="설명"}
플레이어 설정, 시간 차원을 지정하는 데 사용되며 동적 꺾은선 차트의 핵심 설정
