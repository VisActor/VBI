...
데이터가 시간에 따라 변하는 분포 상황을 표시하는 데 적합, 데이터 포인트의 위치로 두 지표의 값 표시

적용 시나리오:

\- 2차원 공간에서 데이터의 분포 특성을 분석하고 시간에 따른 동적 변화 표시

\- 여러 변수 간의 상관관계가 시간에 따라 변화하는 것을 표시

\- 2차원 공간에서 데이터 포인트의 이동 궤적 관찰
...
\- X축과 Y축 모두 수치 축(연속 데이터)이며, 여러 지표 매핑 지원

\- 플레이어를 통해 시간 차원을 제어하고 데이터 변화를 동적으로 표시 지원

\- 데이터 포인트의 위치 변화를 통해 데이터의 동적 변화를 직관적으로 표시
...
:::note{title="설명"}
동적 산점도, 시간에 따른 데이터 분포 변화를 표시하는 데 적합
...
:::note{title="설명"}
차원, 서로 다른 데이터 시리즈를 구분하고 범례를 표시하는 데 사용
...
:::note{title="설명"}
지표, 최소 2개의 지표를 각각 X축과 Y축에 매핑해야 함
...
:::note{title="설명"}
플레이어 구성, 시간 차원을 지정하는 데 사용되며, 동적 산점도의 핵심 구성

플레이어를 통해 시간 차원의 재생 진행률을 제어하여 데이터의 동적 업데이트 구현
...
:::note{title="설명"}
레이블 구성, 데이터 포인트에 데이터 레이블을 표시하는 데 사용
...
:::note{title="설명"}
데이터 포인트 스타일 구성, 단일 스타일 또는 배열 형태로 지정 가능하며, 전역 스타일 또는 조건부 스타일 구성 지원
