...
데이터가 시간에 따라 변하는 비율 관계를 표시하는 데 적합, 부채꼴 면적 크기로 각 카테고리의 비율 표시

적용 시나리오:

\- 분류 데이터의 비율 분포가 시간에 따라 변화하는 것을 표시

\- 데이터의 전체와 부분 관계가 시간 차원에서 변화하는 것을 강조

\- 다른 카테고리의 전체 대비 비율 변동 관찰
...
:::note{title="설명"}
동적 파이 차트, 데이터가 시간에 따라 변하는 비율 관계를 표시하는 데 적합
...
:::note{title="설명"}
플레이어 설정, 시간 차원을 지정하는 데 사용되며 동적 파이 차트의 핵심 설정
