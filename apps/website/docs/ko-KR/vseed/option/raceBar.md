...
:::note{title="설명"}
동적 막대 차트, 데이터의 시간별 순위 변화를 표시하는 데 적합
...
:::note{title="설명"}
플레이어 구성, 시간 차원 지정에 사용, 동적 막대 차트의 핵심 구성
...
:::note{title="설명"}
정렬 설정, 동적 막대 차트는 일반적으로 값에 따라 동적으로 정렬해야 함
...
:::note{title="설명"}
Y축 설정, 카테고리 축으로 차원 값을 표시, 막대는 세로로 배열
