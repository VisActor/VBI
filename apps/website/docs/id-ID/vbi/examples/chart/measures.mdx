...
Tambahkan metrik dan atur pengkodean
...
Format pengukuran: Volume penjualan menggunakan format khusus 10.000 yuan (awalan ¥, dengan 2 tempat desimal), margin keuntungan menggunakan format otomatis, dan diskon menggunakan format persentase.
