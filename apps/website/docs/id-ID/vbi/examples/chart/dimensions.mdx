...
Tambahkan dimensi tanggal yang dikumpulkan berdasarkan tahun
...
Tambahkan beberapa dimensi (panggilan berantai)
...
Pengelompokan campuran dimensi biasa dan dimensi tanggal dikumpulkan per kuartal
...
Perbarui dimensi tanggal yang ada untuk diagregasi berdasarkan bulan
