...
Cocok untuk menampilkan perubahan peringkat data dari waktu ke waktu
...
:::note{title="Deskripsi"}
Diagram batang dinamis, cocok untuk menampilkan peringkat data dari waktu ke waktu
...
**Tipe:** `RaceBarDimension[] | undefined`
...
**Tipe:** `"color" | "detail" | "tooltip" | "label" | "row" | "column" | "yAxis" | "player" | undefined`

:::note{title="Deskripsi"}
Saluran pemetaan dimensi

\- player: mendukung pemetaan berbagai dimensi ke saluran pemutaran
...
Konfigurasi pemutar, yang digunakan untuk menentukan nama field pemutaran, harus berupa dimensi

:::

:::warning{title="Peringatan"}
Fungsi ini tidak mendukung tipe bagan seperti tabel, pivotTable, dualAxis, histogram, boxPlot, dll., dan tidak mendukung penggunaan ketika kombinasi metrik atau perspektif baris-kolom diaktifkan.
...
:::note{title="Deskripsi"}
Jumlah maksimum pemutaran. Data yang melebihi angka ini akan terpotong. Setel ke false untuk menunjukkan tanpa batas.
...
:::note{title="Deskripsi"}
Apakah akan memutar secara otomatis
...
:::note{title="Deskripsi"}
Warna trek bilah kemajuan pemain
...
:::note{title="Deskripsi"}
Warna kemajuan bilah kemajuan pemain
...
:::note{title="Deskripsi"}
Warna penggeser bilah kemajuan pemain
...
:::note{title="Deskripsi"}
Warna batas penggeser bilah kemajuan pemain
...
:::note{title="Deskripsi"}
Konfigurasi pengurutan, diagram batang dinamis biasanya perlu diurutkan secara dinamis berdasarkan nilai numerik
...
:::note{title="Deskripsi"}
Konfigurasi informasi yang cepat
...
:::note{title="Deskripsi"}
konfigurasi sumbu X, yaitu sumbu numerik dan menampilkan nilai metrik
...
:::note{title="Deskripsi"}
Konfigurasi sumbu Y, yaitu sumbu kategori, menampilkan nilai dimensi, dan kolom disusun secara vertikal
...
:::note{title="Deskripsi"}
Konfigurasi kotak prompt horizontal
...
:::note{title="Deskripsi"}
Ketinggian maksimum persegi panjang
...
:::note{title="Deskripsi"}
Konfigurasi penyortiran legenda
...
:::note{title="Deskripsi"}
Konfigurasi keterkaitan dimensi
