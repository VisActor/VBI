...
Bagan area persen mendukung saluran visual berikut:
...
Bagan area persentase, cocok untuk menunjukkan tren perubahan proporsi multi-kategori dari waktu ke waktu. Sumbu Y menunjukkan hubungan proporsi dalam bentuk persentase.

Skenario penggunaan:

\- Analisis perubahan komposisi deret waktu

\- Perbandingan tren proporsi multikategori

\- Proporsi kumulatif dan proporsi satu kategori ditampilkan secara bersamaan
...
Grafik persentase luas, menunjukkan perubahan proporsi beberapa kategori dengan dimensi tertentu dalam bentuk persentase
...
Kumpulan data gabungan yang sesuai dengan spesifikasi TidyData digunakan untuk menentukan sumber data dan struktur bagan. Kumpulan data yang dimasukkan oleh pengguna tidak memerlukan pemrosesan apa pun. VSeed memiliki fungsi pembentukan ulang data yang kuat dan akan membentuk ulang datanya sendiri. Data grafik persentase luas pada akhirnya akan diubah menjadi 2 dimensi dan 1 metrik.

:::

**Contoh**
```ts
[{bulan:'Januari', kategori:'A', value:30}, {bulan:'Januari', kategori:'B', value:70}]
...
Metrik grafik persentase area akan secara otomatis digabungkan menjadi satu metrik, dipetakan ke sumbu Y, dan nama metrik akan digabungkan dengan dimensi lain dan ditampilkan sebagai item legenda.
