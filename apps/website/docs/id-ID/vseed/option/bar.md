...
Diagram batang mendukung saluran visual berikut:
...
Bagan batang, cocok untuk skenario perbandingan data horizontal. Sumbu Y adalah sumbu kategori (data kategori), sumbu X adalah sumbu numerik (data kontinu), dan kolom-kolom disusun secara horizontal.

Skenario penggunaan:

\- Jika nama item datanya panjang

\- Perlu menampilkan perbandingan peringkat data
...
:::note{title="Deskripsi"}
Sumber data, kumpulan data yang sesuai dengan spesifikasi TidyData dan telah dikumpulkan, digunakan untuk menentukan sumber data dan struktur bagan. Kumpulan data yang dimasukkan oleh pengguna tidak perlu diproses dengan cara apa pun. VSeed memiliki fungsi pembentukan ulang data yang kuat dan akan membentuk ulang data dengan sendirinya. Data diagram batang pada akhirnya akan diubah menjadi 2 dimensi dan 1 metrik.
...
**Contoh**
```ts
[{id: "date", alias: "Tanggal"}, {id: "value", alias: "Nomor"}]
...
Metrik dan metrik diagram batang akan secara otomatis digabungkan menjadi satu metrik dan dipetakan ke sumbu X. Jika terdapat beberapa metrik, nama metrik akan digabungkan dengan dimensi lain dan ditampilkan sebagai item legenda.
