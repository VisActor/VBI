...
Bagan batang, cocok untuk skenario perbandingan data vertikal. Sumbu X adalah sumbu kategori (data kategori), sumbu Y adalah sumbu numerik (data kontinu), dan kolom-kolom disusun secara vertikal.
...
:::note{title="Deskripsi"}
Dimensi pertama histogram dipetakan ke sumbu X, dan dimensi lainnya akan digabungkan dengan nama metrik (bila terdapat beberapa metrik) dan ditampilkan sebagai item legenda
...
:::note{title="Deskripsi"}
Seluruh metrik histogram akan otomatis digabungkan menjadi satu metrik dan dipetakan ke sumbu Y. Jika terdapat beberapa metrik, nama metrik akan digabungkan dengan dimensi lain dan ditampilkan sebagai item legenda.
...
Konfigurasi garis regresi polinomial, termasuk urutan polinomial, gaya garis regresi, dll.
...
Digunakan untuk mengatur warna garis regresi. Jika tidak disetel, warna utama bagan akan digunakan secara default.
...
Digunakan untuk mengatur lebar garis regresi, satuannya adalah piksel, nilai defaultnya adalah 1
...
Digunakan untuk mengatur gaya garis regresi, seperti garis padat, garis putus-putus, dll. Nilai defaultnya adalah garis padat
...
Label teks digunakan untuk mengatur garis regresi. String kosong berarti tidak ada label yang ditampilkan.
...
:::note{title="Deskripsi"}
Apakah akan menampilkan interval kepercayaan
...
:::note{title="Deskripsi"}
Pengaturan nilai interval kepercayaan, tingkat kepercayaan default 95%.
...
:::note{title="Deskripsi"}
Transparansi interval kepercayaan
