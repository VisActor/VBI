...
Bagan batang persentase, cocok untuk skenario di mana proporsi setiap kategori ditampilkan secara horizontal. Sumbu X menampilkan proporsi data dalam bentuk persentase.

Skenario penggunaan:

\- Perbandingan proporsi ketika nama kategori panjang

\- Analisis komposisi horizontal data multidimensi

\- Skenario di mana peringkat dan proporsi ditampilkan secara bersamaan
...
\- minimal 1 field dimensi dan 1 field ukuran

\-Jumlah proporsi semua kategori adalah 100%

\- Mendukung penumpukan multi-seri untuk menampilkan hubungan proporsional

Fitur yang diaktifkan secara default:

\-Legenda, sumbu, label persentase, informasi cepat, dan perhitungan proporsi diaktifkan secara default.
...
:::note{title="Deskripsi"}
Diagram batang persentase, menunjukkan hubungan proporsi setiap kategori data dalam bentuk persentase horizontal
...
:::note{title="Deskripsi"}
Sumber data, kumpulan data yang sesuai dengan spesifikasi TidyData dan telah dikumpulkan, digunakan untuk menentukan sumber data dan struktur bagan. Kumpulan data yang dimasukkan oleh pengguna tidak memerlukan pemrosesan apa pun. VSeed memiliki fungsi pembentukan ulang data yang kuat dan akan membentuk ulang data dengan sendirinya. Data diagram batang persentase pada akhirnya akan diubah menjadi 2 dimensi dan 1 metrik.
...
:::note{title="Deskripsi"}
Dimensi, dimensi pertama akan ditempatkan pada sumbu Y, dan dimensi lainnya akan digabungkan dengan nama metrik (bila terdapat beberapa metrik) dan ditampilkan sebagai item legenda.
...
:::note{title="Deskripsi"}
Metrik akan otomatis digabungkan menjadi satu metrik dan dipetakan ke sumbu X. Jika terdapat beberapa metrik, nama metrik akan digabungkan dengan dimensi lain dan ditampilkan sebagai item legenda.
...
:::note{title="Deskripsi"}
Beri label pada garis vertikal
...
:::note{title="Deskripsi"}
Beri label pada garis horizontal
