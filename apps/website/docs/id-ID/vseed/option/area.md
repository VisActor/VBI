...
Bagan area mendukung saluran visual berikut:
...
Bagan area cocok untuk menampilkan tren dan hubungan kumulatif data dari waktu ke waktu, dan meningkatkan perbandingan data dengan mengisi area. Sumbu X adalah sumbu kategori (data kategorikal), dan sumbu Y adalah sumbu numerik (data kontinu).

Skenario penggunaan:

\-Tampilkan perubahan tren dalam satu seri data

\- Penekanan pada efek kumulatif jumlah total dari waktu ke waktu

\- Bandingkan perbedaan total dalam beberapa seri data
...
\- Field dimensi pertama dipetakan ke sumbu X, dan field dimensi lainnya akan digabungkan dengan nama metrik (bila terdapat beberapa metrik) dan ditampilkan sebagai item legenda.

\- Semua metrik akan otomatis digabungkan menjadi satu metrik

Fitur yang diaktifkan secara default:

\- Modul memungkinkan penumpukan

\-Legenda, sumbu koordinat, isian area, label data, dan informasi cepat diaktifkan secara default.
...
Bagan area, tipe bagan yang menampilkan tren data dan hubungan kumulatif.
...
Dimensi pertama dipetakan ke sumbu X, dan dimensi lainnya digabungkan dengan nama metrik (bila terdapat beberapa metrik) dan ditampilkan sebagai item legenda.

:::

**Contoh**
```ts
[{ id: 'bulan', alias: 'bulan' }, { id: 'tahun', alias: 'tahun' }]
...
Metrik-metrik grafik area akan secara otomatis digabungkan menjadi satu metrik dan dipetakan ke sumbu Y. Nama metrik akan digabungkan dengan dimensi lain dan ditampilkan sebagai item legenda.
