...
Histogram berdampingan mendukung saluran visual berikut:
...
Histogram berdampingan, cocok untuk skenario perbandingan paralel beberapa metrik. Beberapa kolom disusun berdampingan untuk menampilkan nilai metrik yang berbeda.
...
\-Analisis korelasi antar metrik
...
\-Legenda, sumbu koordinat, label data, informasi cepat, dan pengurutan metrik diaktifkan secara default.
...
:::note{title="Deskripsi"}
Histogram berdampingan, cocok untuk skenario perbandingan paralel multi-metrik
...
:::note{title="Deskripsi"}
Kumpulan data, kumpulan data gabungan yang sesuai dengan spesifikasi TidyData, digunakan untuk menentukan sumber data dan struktur bagan. Kumpulan data yang dimasukkan oleh pengguna tidak memerlukan pemrosesan apa pun. VSeed memiliki fungsi pembentukan ulang data yang kuat dan akan membentuk ulang datanya sendiri. Data histogram berdampingan pada akhirnya akan diubah menjadi 2 dimensi dan 1 metrik.
...
:::note{title="Deskripsi"}
Dimensi, dimensi pertama dipetakan ke sumbu X, dan dimensi lainnya akan digabungkan dengan nama metrik (bila terdapat beberapa metrik) dan ditampilkan sebagai item legenda.
...
:::note{title="Deskripsi"}
Metrik, seluruh metrik histogram yang berdampingan akan otomatis digabungkan menjadi satu metrik dan dipetakan ke sumbu Y. Jika terdapat beberapa metrik, nama metrik akan digabungkan dengan dimensi lain dan ditampilkan sebagai item legenda.
...
:::note{title="Deskripsi"}
Bagan kolom ditumpuk dengan sudut membulat
...
:::note{title="Deskripsi"}
Gaya primitif persegi panjang, konfigurasi gaya bagan kolom paralel, digunakan untuk menentukan gaya bagan kolom paralel dari bagan, termasuk warna, batas, sudut membulat, dll. dari bagan kolom paralel.
