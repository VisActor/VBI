...
Diner dinamis(Race Line Chart)

Applies untuk menampilkan kecenderungan data dari waktu ke waktu dengan menghubungkan titik data untuk membuat garis tren

Terapkan adegan:

\- Tampilkan tren dari waktu ke waktu untuk multiple data series

\- Perbandingan pertumbuhan atau pola penurunan dalam kategori berbeda

\- Pengamatan fluktuasi data dalam dimensi waktu
...
\- Sumbu X biasanya sumbu waktu atau kelas, menampilkan dimensi

\- Sumbu Y adalah sumbu numerik yang menunjukkan nilai metrik

\- Mendukung kontrol dimensi waktu melalui pemain, dinamis menampilkan ekstensi baris
...
:::note{title="Deskripsi"}
Kontur dinamis, dapat diterapkan untuk menampilkan kecenderungan data dari waktu ke waktu
...
:::note{title="Deskripsi"}
Konfigurasi Pemutar, Untuk menentukan dimensi waktu, Konfigurasi inti dari kurva dinamis
...
:::note{title="Deskripsi"}
Konfigurasi sumbu X, untuk sumbu kelas, dimensi tampilan
...
:::note{title="Deskripsi"}
Konfigurasi baris ujung vertikal
...
:::note{title="Deskripsi"}
Konfigurasi Baris Penanda Lebar
...
:::note{title="Deskripsi"}
Konfigurasi baris komentar numerik
