...
Peta Rose Grup mendukung saluran visual berikut:
...
Memkelompokkan mawar, berlaku untuk multi- dimensi data kontras adegan, menampilkan ukuran data oleh sektor radians dan radiuss di bawah koordinat kutub
...
Dikelompokkan mawar, menampilkan data multi- dimensi bertentangan dengan koordinat kutub
