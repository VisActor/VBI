...
Bagan batang persentase, cocok untuk skenario yang menunjukkan hubungan proporsi berbagai kategori. Sumbu Y menampilkan proporsi data dalam bentuk persentase.

Skenario penggunaan:

\- Perbandingan proporsi berbagai kategori data

\-Analisis komposisi data multidimensi

\- Tren perubahan proporsi deret waktu
...
:::note{title="Deskripsi"}
Bagan batang persentase



Diagram batang persentase, menunjukkan hubungan proporsi setiap kategori data dalam bentuk persentase
...
Metrik persentase histogram akan otomatis digabungkan menjadi satu metrik dan dipetakan ke sumbu Y. Jika terdapat beberapa metrik, nama metrik akan digabungkan dengan dimensi lain dan ditampilkan sebagai item legenda.
...
:::note{title="Deskripsi"}
Bagan kolom berdampingan Bertumpuk sudut membulat
...
:::note{title="Deskripsi"}
Gaya primitif persegi panjang, digunakan untuk menentukan gaya primitif persegi panjang pada bagan, termasuk warna, batas, sudut membulat, dll. dari primitif persegi panjang.
