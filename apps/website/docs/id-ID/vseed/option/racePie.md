...
Bagan Pie Dinamis(Race Pie Chart)

Hubungan proporsional dapat diterapkan untuk menampilkan data seiring waktu, menunjukkan kategori berdasarkan ukuran sektor Itu benar.

Skenario penggunaan:

\- Tampilkan distribusi persentase dari data berbeda dari waktu ke waktu

\- Penekanan pada evolusi keseluruhan dan parsial hubungan data dari dimensi waktu

\- Pengamatan fluktuasi dalam pembagian kategori yang berbeda secara total
...
\- Daerah sektor disesuaikan untuk perubahan data
...
:::note{title="Deskripsi"}
Grafik pim dinamis, dapat diterapkan untuk menampilkan hubungan rasio dari waktu ke waktu
...
**Tipe:** `RacePieDimension[] | undefined`
...
:::note{title="Deskripsi"}
Konfigurasi Pemutar, Untuk menentukan dimensi waktu, Konfigurasi inti dari pie dinamis
