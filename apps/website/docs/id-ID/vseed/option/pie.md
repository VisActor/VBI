...
Diagram lingkaran mendukung saluran visual berikut:
...
Diagram lingkaran cocok untuk menampilkan hubungan proporsi data satu dimensi. Proporsi masing-masing kategori diwakili oleh luas sektor.

Skenario penggunaan:

\- Menampilkan distribusi proporsi data kategorikal

\- Tekankan hubungan antara keseluruhan dan bagian data

\-Analisis proporsi sejumlah kecil kategori (direkomendasikan tidak lebih dari 6)
...
Diagram lingkaran, menunjukkan hubungan proporsi data dimensi tunggal
...
Semua dimensi diagram lingkaran akan digabungkan dengan nama metrik (jika terdapat beberapa metrik) menjadi satu dimensi, dipetakan ke sudut, dan ditampilkan sebagai item legenda
...
Semua metrik diagram lingkaran akan otomatis digabungkan menjadi satu metrik dan dipetakan ke sumbu radius. Jika terdapat beberapa metrik, nama metrik akan digabungkan dengan dimensi lainnya dan ditampilkan sebagai item legenda.
