...
Bagan donat mendukung saluran visual berikut:

`angle`: Saluran sudut, mendukung `beberapa metrik`, dipetakan ke sudut sektor sesuai dengan nilai indeks
...
Bagan donat cocok untuk menampilkan hubungan proporsi data satu dimensi. Ada area kosong di tengah untuk menampilkan informasi ringkasan.

Skenario penggunaan:

\- Perlu menampilkan data keseluruhan dan proporsi setiap bagian secara bersamaan

\- Tekankan hubungan antara keseluruhan dan bagian data

\-Area pusat perlu menampilkan metrik atau judul utama
...
\- Semua dimensi akan digabungkan dengan nama metrik (bila terdapat beberapa metrik) dan ditampilkan sebagai item legenda.

\- Semua metrik akan otomatis digabungkan menjadi satu metrik

Fitur yang diaktifkan secara default:

\-Legenda, label data, informasi cepat, penghitungan proporsi, dan teks tengah diaktifkan secara default.
...
Bagan donat, variasi diagram lingkaran dengan spasi putih di tengahnya
...
Semua dimensi diagram donat akan digabungkan dengan nama metrik (jika terdapat beberapa metrik) menjadi satu dimensi, dipetakan ke sudut diagram lingkaran, dan ditampilkan sebagai item legenda.
...
Semua metrik diagram donat akan otomatis digabungkan menjadi satu metrik, dipetakan ke radius diagram lingkaran. Jika terdapat beberapa metrik, nama metrik akan digabungkan dengan dimensi lainnya dan ditampilkan sebagai item legenda.
...
:::note{title="Deskripsi"}
Metode tata letak label, hanya efektif untuk diagram lingkaran dan diagram donat dan ketika `labelPosition` adalah `outside`

\- arc: label tata letak menurut bentuk busur

\- labelLine: Sejajarkan kedua ujung label, hubungkan primitif sektor dan label melalui garis panduan

\- edge: Sejajarkan kedua ujung label, sambungkan primitif berbentuk kipas dan label melalui garis panduan, dan dekatkan ke tepi kedua ujung bagan
...
:::note{title="Deskripsi"}
Apakah akan mengaktifkan animasi diagram lingkaran/diagram cincin/grafik mawar
...
:::note{title="Deskripsi"}
Parameter animasi diagram lingkaran/diagram cincin/diagram mawar
...
:::note{title="Deskripsi"}
Konfigurasi animasi entri diagram lingkaran/diagram cincin/diagram mawar
...
:::note{title="Deskripsi"}
Efek entri diagram lingkaran/grafik cincin/grafik mawar, mendukung animasi radial dan zoom
...
:::note{title="Deskripsi"}
Konfigurasi animasi pembaruan diagram lingkaran/diagram cincin/diagram mawar
...
:::note{title="Deskripsi"}
Efek pembaruan diagram lingkaran/grafik cincin/grafik mawar, mendukung animasi radial
...
:::note{title="Deskripsi"}
Konfigurasi animasi siklus diagram lingkaran/diagram cincin/diagram mawar
...
:::note{title="Deskripsi"}
Bagan pai/bagan cincin/efek lingkaran bagan mawar
...
:::note{title="Deskripsi"}
Konfigurasi animasi suasana diagram lingkaran/diagram cincin/diagram mawar
