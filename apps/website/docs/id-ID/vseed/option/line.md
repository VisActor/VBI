...
Bagan garis mendukung saluran visual berikut:

`x`: saluran sumbu X, mendukung `beberapa dimensi`, dipetakan ke sumbu X sesuai dengan nilai dimensi

`y`: saluran sumbu Y, mendukung `beberapa metrik`, dipetakan ke sumbu Y sesuai dengan nilai metrik
...
Bagan garis cocok untuk menampilkan tren perubahan data dari waktu ke waktu atau kategori yang diurutkan. Titik-titik data dihubungkan dengan ruas garis membentuk garis tren.

Skenario penggunaan:

\- Menampilkan tren perubahan data deret waktu

\- Bandingkan tren di beberapa seri data

\-Analisis pola pertumbuhan atau penurunan data
...
\-Legenda, sumbu koordinat, penanda titik data, informasi cepat, dan garis tren diaktifkan secara default.
...
:::note{title="Deskripsi"}
Bagan garis, cocok untuk menampilkan tren data dari waktu ke waktu atau kategori yang diurutkan
...
:::note{title="Deskripsi"}
Dimensi, dimensi pertama diagram garis dipetakan ke sumbu X, dan dimensi lainnya akan digabungkan dengan nama metrik (bila ada beberapa metrik) dan ditampilkan sebagai item legenda
...
:::note{title="Deskripsi"}
Metrik, semua metrik pada grafik garis akan secara otomatis digabungkan menjadi satu metrik dan dipetakan ke sumbu Y. Jika terdapat beberapa metrik, nama metrik akan digabungkan dengan dimensi lain dan ditampilkan sebagai item legenda.
...
\- yAxis: sumbu Y dari pemetaan metrik
...
**Tipe:** `LineAreaAnimation | undefined`
...
:::note{title="Deskripsi"}
Apakah akan mengaktifkan animasi bagan garis/area

:::

### params

**Tipe:** `LineAreaAnimationParams | undefined`

:::note{title="Deskripsi"}
Parameter animasi bagan garis/area
...
**Tipe:** `LineAreaAppearAnimation | undefined`

:::note{title="Deskripsi"}
Konfigurasi animasi entri diagram garis/area
...
**Tipe:** `("load" | "growth")[] | undefined`

:::note{title="Deskripsi"}
Efek entri grafik garis/area, mendukung animasi pemuatan dan pertumbuhan
...
**Tipe:** `LineAreaUpdateAnimation | undefined`

:::note{title="Deskripsi"}
Konfigurasi animasi pembaruan bagan garis/area
...
:::note{title="Deskripsi"}
Efek pembaruan grafik garis/area, mendukung animasi pertumbuhan
...
**Tipe:** `LineAreaAnimationLoop | undefined`

:::note{title="Deskripsi"}
Konfigurasi animasi siklus diagram garis/area
...
**Tipe:** `LineAreaLoopAnimation | undefined`
...
**Tipe:** `LineAreaLoopEffect[] | undefined`

:::note{title="Deskripsi"}
Efek lingkaran grafik garis/area
...
:::note{title="Deskripsi"}
Konfigurasi animasi suasana bagan garis/area
...
Sumbu kategori, konfigurasi sumbu X, digunakan untuk menentukan sumbu X pada bagan, termasuk posisi, format, gaya, dll. dari sumbu X.
...
Sumbu nilai, konfigurasi sumbu Y, digunakan untuk menentukan sumbu Y pada bagan, termasuk posisi, format, gaya, dll. dari sumbu Y.
...
:::note{title="Deskripsi"}
garis ujung vertikal



Saat mouse digerakkan ke atas grafik, garis prompt vertikal ditampilkan



Konfigurasi garis crosshair, jenis konfigurasi yang digunakan untuk menampilkan garis crosshair (garis ujung) pada grafik
...
:::note{title="Deskripsi"}
Apakah akan menampilkan garis bidik
...
:::note{title="Deskripsi"}
Apakah akan menampilkan label garis bidik
...
:::note{title="Deskripsi"}
Warna latar belakang label garis crosshair
...
Berdasarkan dua titik data yang dipilih, buat garis label perbedaan dan hitung teks perbedaan secara otomatis.
