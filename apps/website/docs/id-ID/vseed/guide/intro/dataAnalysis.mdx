...
## Penyortiran sumbu dan penyortiran legenda

VSeed menyediakan konfigurasi penyortiran yang mudah.

- `sort`: digunakan untuk mengonfigurasi aturan pengurutan data sumbu, mendukung spesifikasi field pengurutan `orderBy` dan urutan pengurutan `order`.
