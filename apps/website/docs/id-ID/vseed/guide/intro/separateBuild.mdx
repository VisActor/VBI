...
:::tip
Biasanya, pemrosesan data grafik memakan waktu. `buildSpec` mendukung pemrosesan data terpisah dan rendering data. VSeed menyediakan `build` dan `buildAdvanced` untuk konstruksi terpisah.
:::
...
Contoh berikut menunjukkan cara menggunakan proses pembangunan yang dipisahkan dalam komponen React.
