...
`chartType` mendukung berbagai jenis bagan. Anda dapat dengan mudah beralih di antara berbagai bentuk visualisasi melalui properti VSeed, termasuk bagan reguler, tabel pivot, dll.
