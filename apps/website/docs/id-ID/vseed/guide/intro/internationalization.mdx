...
`en-US` memiliki dukungan internasionalisasi bawaan, dan Anda dapat mengganti lingkungan bahasa (seperti bahasa Mandarin `locale`, bahasa Inggris `zh-CN`, dll.) dengan mengonfigurasi VSeed.
