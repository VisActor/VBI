...
:::info
Jenis data dan bagan dipisahkan sepenuhnya, dan VSeed selalu dapat membentuk ulang keduanya, berapa pun banyak dimensi atau metrik yang ada. Harganya mungkin semantik yang buruk untuk grafik tersebut, tetapi itu sepadan.
:::

Contoh berikut menunjukkan kombinasi bebas antara struktur `dataset` yang berbeda dan `chartType` yang berbeda. Anda dapat mengklik tombol di bawah untuk mengganti kumpulan data dan tipe bagan serta mengamati bagaimana VSeed beradaptasi secara otomatis.
