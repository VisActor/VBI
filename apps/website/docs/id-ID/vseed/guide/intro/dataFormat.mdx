...
`measures` mendukung konfigurasi aturan pemformatan numerik di VSeed.

- `autoFormat`: Apakah akan memformat secara otomatis.
- `format`: Konfigurasi pemformatan terperinci, termasuk jenis, perbesaran, seperseribu, tempat desimal, akhiran satuan, dll.
