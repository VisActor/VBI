...
VSeed Unterstützt am `measures` Formatierungsregeln für Werte in konfigurieren.

- `autoFormat`: Ob automatisch formatiert werden soll.
- `format`: Detaillierte Formatierungskonfiguration, einschließlich Typ, Vergrößerung, Tausendstel, Dezimalstellen, Einheitenpräfixe usw.
