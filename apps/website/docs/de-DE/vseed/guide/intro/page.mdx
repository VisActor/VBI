...
# Seitennummerierung der Daten

## Grundlegende Beispiele

Nach Konfiguration `page` Eine Eigenschaft, mit der Sie ein Diagramm angeben können, das Daten für einen bestimmten Dimensionswert anzeigt.

- `field`: Seitennummerierungsfeld.
...
Bestanden `page` Die Eigenschaft ermöglicht in Kombination mit der React-Zustandsverwaltung eine benutzerdefinierte Spielersteuerung.
