...
VSeed Mehrere Diagrammtypen werden unterstützt von `chartType` Eigenschaften machen es einfach, zwischen verschiedenen Visualisierungen zu wechseln, einschließlich normaler Diagramme, Pivot-Tabellen und mehr.
