...
Gruppierte Rosendiagramme unterstützen die folgenden visuellen Kanäle:
...
Gruppiertes Rosendiagramm, geeignet für mehrdimensionale Datenvergleichsszenarien, das die Datengröße nach Sektorradius und Radius unter dem Polarkoordinatensystem anzeigt

Szenario:

\- Verteilungsvergleich mehrdimensionaler Daten

\- Vergleich der Stärken und Schwächen periodischer Daten

\- Wert und Anteil der klassifizierten Daten werden gleichzeitig angezeigt
...
\- Die erste Dimension geht zur Winkelachse, Die verbleibenden Dimensionen werden mit dem Metriknamen zusammengeführt (wenn mehrere Metriken vorhanden sind), Als Legendenelement anzeigen

\- Alle Metriken werden automatisch zu einer Metrik zusammengeführt

Standardmäßig eingeschaltete Funktionen:

\- Legende, Polarkoordinatensystem, Datenbeschriftungen, Eingabeaufforderung, numerische Skalierung sind standardmäßig aktiviert
...
:::note{title="Beschreibung"}
Gruppiertes Rosendiagramm



Gruppiertes Rosendiagramm, mehrdimensionale Datenvergleichsbeziehung durch Polarkoordinatensystem anzeigen
...
Die erste Dimension des Rosendiagramms wird der Winkelachse zugeordnet; die übrigen Dimensionen werden mit dem Kennzahlnamen zusammengeführt (wenn mehrere Kennzahlen vorhanden sind) und als Legendenelement angezeigt.
...
Die Kennzahlen des Rosendiagramms werden automatisch zu einer Kennzahl zusammengeführt und auf die Radiusachse abgebildet; bei mehreren Kennzahlen wird der Kennzahlname mit den übrigen Dimensionen zusammengeführt und als Legendenelement angezeigt.
