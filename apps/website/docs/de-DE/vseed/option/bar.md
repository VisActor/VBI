...
Balkendiagramm, geeignet für horizontale Datenvergleichsszenarien, die Y-Achse ist die Kategorieachse (Klassifizierungsdaten), die X-Achse ist die numerische Achse (kontinuierliche Daten), die Spalten sind horizontal angeordnet

Szenario:

\- Wenn der Name des Datenelements länger ist

\- Muss Daten-Ranking-Vergleich anzeigen

\- Positive und negative bidirektionale Daten zeigen
...
**Beispiel**
```ts
[{id: "date", alias: "Datum"}, {id: "value", alias: "Wert"}]
...
Kennzahl, Balkenmetriken werden automatisch zu einer Metrik zusammengeführt, Auf X-Achse zuordnen, Wenn es mehrere Metriken gibt, Der Metrikname wird mit dem Rest der Dimensionen zusammengeführt, Wird als Legendenelement angezeigt.
