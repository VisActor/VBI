...
Side-by-Side-Histogramme unterstützen die folgenden visuellen Kanäle:
...
Side-by-Side-Balkendiagramm, geeignet für Multi-Index-Parallel-Vergleichsszenarien, mehrere Spalten sind nebeneinander angeordnet, um verschiedene Indexwerte anzuzeigen

Szenario:

\- Paralleler Vergleich mehrerer Indikatoren in der gleichen Dimension

\- Horizontaler Vergleich mehrdimensionaler Daten

\- Interindikator-Korrelationsanalyse
...
\- Standardmäßig sind Legende, Achse, Datenbeschriftungen, Eingabeaufforderungsinformationen und Metrikreihenfolge aktiviert.
...
:::note{title="Beschreibung"}
Side-by-Side-Histogramme für Multi-Index-Parallelvergleichsszenarien
...
:::note{title="Beschreibung"}
Dimension, Die erste Dimension wird auf die X-Achse abgebildet, Die verbleibenden Dimensionen werden mit dem Metriknamen zusammengeführt (wenn mehrere Metriken vorhanden sind), Wird als Legendenelement angezeigt.
...
:::note{title="Beschreibung"}
Kennzahl, Alle Metriken eines Side-by-Side-Histogramms werden automatisch zu einer Metrik zusammengeführt, Zuordnen zur Y-Achse, Wenn es mehrere Metriken gibt, Der Metrikname wird mit dem Rest der Dimensionen zusammengeführt, Wird als Legendenelement angezeigt.

:::

**Beispiel**
```ts
[{id: 'value1', alias: 'Indikator 1'}, {id: 'value2', alias: 'Indikator 2'}]
...
:::note{title="Beschreibung"}
Balkendiagramm gestapelte abgerundete Ecken
...
:::note{title="Beschreibung"}
Rechteckiger primitiver Stil, Side-by-Side-Histogramm-Stilkonfiguration, Wird verwendet, um nebeneinander Histogrammstile für Diagramme zu definieren, Farben für Side-by-Side-Histogramme einschließen, Rahmen, Abgerundete Ecken usw.
...
:::note{title="Beschreibung"}
Differenz-Callout-Konfiguration, verwendet, um zwei Datenanker zu binden und die absolute Differenz oder prozentuale Differenz anzuzeigen.
