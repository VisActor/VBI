...
Das prozentuale Histogramm unterstützt die folgenden visuellen Kanäle:
...
Prozentuales Balkendiagramm, geeignet für Szenarien, die den Anteil jeder Kategorie zeigen, Y-Achse zeigt den Anteil der Daten in prozentualer Form
...
\- Trends im Anteil der Zeitreihen
...
Prozentuales Balkendiagramm, das den Datenanteil jeder Kategorie als Prozentsatz anzeigt
...
Prozentbalken-Metriken werden automatisch zu einer Metrik zusammengeführt, Zuordnen zur Y-Achse, Wenn es mehrere Metriken gibt, Der Metrikname wird mit dem Rest der Dimensionen zusammengeführt, Wird als Legendenelement angezeigt.
...
:::note{title="Beschreibung"}
Seite-an-Seite-Histogramme gestapelte abgerundete Ecken
...
:::note{title="Beschreibung"}
Rechteckiger primitiver Stil, Rechteckiger primitiver Stil zur Definition von Diagrammen, Farbe der rechteckigen Grundelemente einschließen, Rahmen, Abgerundete Ecken usw.
