...
Das Tortendiagramm unterstützt die folgenden visuellen Kanäle:
...
Tortendiagramm, geeignet zur Anzeige der Proportionsbeziehung eindimensionaler Daten und zum Ausdruck des Anteils jeder Kategorie durch die Größe des Sektorbereichs

Szenario:

\- Zeigt die Verteilung klassifizierter Daten an
...
Kreisdiagramm, das den Anteil der eindimensionalen Daten zeigt
...
Alle Dimensionen des Kreisdiagramms werden zu einer Dimension mit dem Metriknamen zusammengeführt (wenn mehrere Metriken vorhanden sind), Zu Winkel zuordnen, und als Legendenelement angezeigt
...
Alle Metriken des Tortendiagramms werden automatisch zu einer Metrik zusammengeführt, Auf Radiusachse abbilden, Wenn es mehrere Metriken gibt, Der Metrikname wird mit dem Rest der Dimensionen zusammengeführt, Wird als Legendenelement angezeigt.
