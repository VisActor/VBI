...
Wird verwendet, um die Rangfolge der Daten im Zeitverlauf anzuzeigen
...
\- player: Unterstützung für die Zuordnung mehrerer Dimensionen zu einem Wiedergabekanal
...
:::note{title="Beschreibung"}
Player-Konfiguration, Wird verwendet, um die Zeitdimension anzugeben, Kernkonfiguration für dynamisches Balkendiagramm
...
:::note{title="Beschreibung"}
Sortierkonfiguration, Dynamische Balkendiagramme müssen oft dynamisch nach Werten sortiert werden
...
:::note{title="Beschreibung"}
xAchsenkonfiguration, bei der es sich um eine numerische Achse handelt, die den Indexwert anzeigt
...
:::note{title="Beschreibung"}
yAchsenkonfiguration, für Kategorieachse, Anzeigemaßwert, Spaltenvertikale Anordnung
...
:::note{title="Beschreibung"}
Horizontale Tooltip-Konfiguration
