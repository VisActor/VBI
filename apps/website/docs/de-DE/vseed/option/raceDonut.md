...
Dynamischer Ring (Race Donut Chart)

Es ist geeignet, um den Anteil der Daten anzuzeigen, der sich im Laufe der Zeit ändert, und es gibt einen leeren Bereich in der Mitte, um die zusammenfassenden Informationen anzuzeigen

Anwendbare Gelegenheiten

\- Es ist notwendig, die Änderung der Gesamtdaten und den Anteil jedes Teils über die Zeit gleichzeitig anzuzeigen
...
\- Im Vergleich zum Tortendiagramm ist der mittlere Bereich leer und optisch heller
...
:::note{title="Beschreibung"}
Dynamisches Kreisdiagramm, geeignet zur Darstellung des sich im Laufe der Zeit ändernden Datenanteils
...
:::note{title="Beschreibung"}
Player-Konfiguration, Wird verwendet, um die Zeitdimension anzugeben, Kernkonfiguration für dynamisches Ringdiagramm
