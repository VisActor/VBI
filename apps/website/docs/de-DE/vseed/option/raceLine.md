...
Es eignet sich, um den Trend von Daten über die Zeit anzuzeigen und eine Trendlinie zu bilden, indem Datenpunkte durch Liniensegmente verbunden werden.

Szenario:

\- Trends über mehrere Datenreihen hinweg im Zeitverlauf anzeigen

\- Vergleichen Sie die Wachstums- oder Rückgangsmuster verschiedener Kategorien

\- Schwankungen in der Zeitdimension der Daten beobachten
...
\- XAchsen sind in der Regel Zeitachsen oder Kategorieachsen, die Dimensionswerte anzeigen

\- YAchsen sind numerische Achsen, die metrische Werte anzeigen

\- Unterstützt die Steuerung der Zeitdimension über den Player, um den Erweiterungsprozess der Polylinie dynamisch anzuzeigen
...
:::note{title="Beschreibung"}
Dynamisches Liniendiagramm zur Darstellung von Datentrends im Zeitverlauf
...
:::note{title="Beschreibung"}
Player-Konfiguration, Wird verwendet, um die Zeitdimension anzugeben, Kernkonfiguration für dynamische Liniendiagramme
...
:::note{title="Beschreibung"}
xAchsenkonfiguration, ist eine Kategorieachse, die Dimensionswerte anzeigt
...
:::note{title="Beschreibung"}
Konfiguration der vertikalen Eingabeaufforderung
...
:::note{title="Beschreibung"}
Punktdiagramm Meta-Stilkonfiguration
...
:::note{title="Beschreibung"}
Liniendiagramm Meta-Stilkonfiguration
...
:::note{title="Beschreibung"}
Callout-Konfiguration für den Dimensionswert
...
:::note{title="Beschreibung"}
Numerische Callout-Konfiguration
...
:::note{title="Beschreibung"}
Konfiguration der Dimensionsverknüpfung
