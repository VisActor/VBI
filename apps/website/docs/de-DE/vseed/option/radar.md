...
Die Radarkarte unterstützt folgende visuelle Kanäle:

`angle`: Winkelkanal, Support`mehrere Dimensionen`, Zuordnung zur Winkelachse anhand des Dimensionswerts

`radius`: Radiuskanal, Support`mehrere Kennzahlen`, Zuordnung zur Radiusachse anhand des Kennzahlenwerts
...
Radardiagramm, geeignet für die vergleichende Analyse mehrdimensionaler Daten, das die numerische Verteilung jeder Dimension durch das mehrachsige Koordinatensystem zeigt

Szenario:

\- Umfassender Leistungsvergleich mehrdimensionaler Daten

\- Leistungsbewertung mehrerer Objekte auf mehreren Metriken

\- Mehrdimensionale Merkmalsanzeige klassifizierter Daten
...
\- Die erste Dimension dient als Dimensionsachsen des Radardiagramms, andere Dimensionen werden als unterschiedliche Reihen verglichen

\- Unterstützt mehrere Indikatoren, die als unterschiedliche Serien angezeigt werden

Standardmäßig eingeschaltete Funktionen:

\- Standard-Öffnungslegende, Radarkoordinatensystem, Datenbeschriftungen, Eingabeaufforderung, numerische Skalierung
...
Radardiagramm mit mehrdimensionaler Datenvergleichsbeziehung durch mehrachsiges Koordinatensystem
...
Die erste Dimension des Radardiagramms wird auf die Winkelachse abgebildet, Die verbleibenden Dimensionen werden mit dem Metriknamen zusammengeführt (wenn mehrere Metriken vorhanden sind), Wird als Legendenelement angezeigt.
...
Die Metriken des Radardiagramms werden automatisch zu einer Metrik zusammengeführt, Auf Radiusachse abbilden, Wenn es mehrere Metriken gibt, Der Metrikname wird mit dem Rest der Dimensionen zusammengeführt, Wird als Legendenelement angezeigt.
...
\- radius: Radius der metrischen Karte
...
:::note{title="Beschreibung"}
Ob die Radaranimation aktiviert werden soll
...
:::note{title="Beschreibung"}
Radardiagramm-Animationsparameter
...
:::note{title="Beschreibung"}
Konfiguration der Radareinlass-Animation
...
:::note{title="Beschreibung"}
Radaraufnahmeeffekt mit Radial- und Zoomanimation
...
:::note{title="Beschreibung"}
Radardiagramm-Aktualisierungs-Animationskonfiguration
...
:::note{title="Beschreibung"}
Radardiagramm-Aktualisierungseffekt, Unterstützung der Wachstumsanimation
...
:::note{title="Beschreibung"}
Konfiguration der Radardiagramm-Schleifenanimation
...
:::note{title="Beschreibung"}
Konfiguration der Radaratmosphäre-Animation
