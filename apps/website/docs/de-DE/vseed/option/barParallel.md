...
Side-by-Side Balkendiagramme unterstützen die folgenden visuellen Kanäle:
...
Side-by-Side Balkendiagramm, geeignet für Multi-Index horizontale parallele Vergleichsszenarien, mehrere Balken sind parallel angeordnet, um verschiedene Indexwerte anzuzeigen

Szenario:

\- Vergleich mehrerer Metriken, wenn der Kategoriename lang ist

\- Horizontaler Vergleich von Rankings und Werten gleichzeitig
...
\- Die erste Dimension geht zur Y-Achse, Die verbleibenden Dimensionen werden mit dem Metriknamen zusammengeführt (wenn mehrere Metriken vorhanden sind), Wird als Legendenelement angezeigt.
...
:::note{title="Beschreibung"}
Side-by-Side Balkendiagramm, geeignet für Multi-Index horizontale parallele Vergleichsszenarien
...
:::note{title="Beschreibung"}
Dimension, Die erste Dimension wird auf die Y-Achse abgebildet, Die verbleibenden Dimensionen werden mit dem Metriknamen zusammengeführt (wenn mehrere Metriken vorhanden sind), Wird als Legendenelement angezeigt.
...
:::note{title="Beschreibung"}
Kennzahl, Side-by-Side-Balkendiagramm-Metriken werden automatisch zu einer einzigen Metrik zusammengeführt, Auf X-Achse zuordnen, Wenn es mehrere Metriken gibt, Der Metrikname wird mit dem Rest der Dimensionen zusammengeführt, Wird als Legendenelement angezeigt.
...
:::note{title="Beschreibung"}
Abstand zwischen Rechtecken innerhalb derselben Kategorie; kann ein Pixelwert oder eine Prozentzeichenfolge sein
...
:::note{title="Beschreibung"}
Rechteckiger primitiver Stil, Balkendiagramm-Stilkonfiguration, Balkendiagrammstile zum Definieren von Diagrammen, Farbe für Balkendiagramm einfügen, Rahmen, Abgerundete Ecken usw.
