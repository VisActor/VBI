...
Das Prozentflächendiagramm unterstützt die folgenden visuellen Kanäle:
...
Prozent Flächendiagramm, geeignet zur Darstellung des Trends des Multi-Kategorie-Anteils über die Zeit, Y-Achse zeigt die Proportionsbeziehung in prozentualer Form

Szenario:

\- Analyse von konstituierenden Veränderungen in Zeitreihen

\- Trendvergleich für mehrere Kategorien

\- Der kumulierte Anteil wird gleichzeitig mit dem Anteil einer einzelnen Kategorie angezeigt
...
Prozent-Flächendiagramm, das Änderungen der Anteile mehrerer Kategorien entlang einer Dimension in Prozentform darstellt
...
Die Metrik des prozentualen Flächendiagramms wird automatisch zu einer Metrik zusammengeführt, Zuordnen zur Y-Achse, Der Metrikname wird mit dem Rest der Dimensionen zusammengeführt, Wird als Legendenelement angezeigt.
