...
Sunrise Chart unterstützt die folgenden visuellen Kanäle:
...
Aufgehende-Sonne-Diagramm, verwendet, um hierarchische Daten anzuzeigen, numerische Größe nach Sektorbereichsgröße

Szenario:

\- Demonstration der Anteilsverteilung von mehrstufigen Daten

\- Hervorhebung hierarchischer Beziehungen und Proportionen
...
\- Mindestens 1 numerisches Feld (Metrik) für den Zuordnungsbereich
...
:::note{title="Beschreibung"}
Aufgehende-Sonne-Diagramm



Aufgehende-Sonne-Diagramm, das den Anteil der hierarchischen Daten zeigt
...
Metrische Konfiguration zur Definition der Größe (Fläche) des Sektors
