...
Konfiguriert ein Marken-Theme direkt über den Dashboard Builder. Farben, Text, Hintergründe und Karten verwenden dieselbe Definition, die ohne Komponentenregistrierung mit dem Dokument gespeichert und synchronisiert wird.
