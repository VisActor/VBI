...
Metriken hinzufügen und Kodierung festlegen
...
Messformatierung: Der Umsatz wird in einem benutzerdefinierten Format von 10.000 Yuan formatiert (¥Präfix, 2 Nachkommastellen behalten), die Gewinnspanne wird automatisch formatiert, der Rabatt wird als Prozentsatz formatiert
