...
Measurement formatting: Sales volume uses a custom format of 10,000 yuan (¥ prefix, retaining 2 decimal places), profit margin uses automatic formatting, and discounts use percentage format.
