...
Add date dimension aggregated by year
...
Mixed grouping of ordinary dimensions and date dimensions aggregated by quarter
...
Update the existing date dimension to be aggregated by month
