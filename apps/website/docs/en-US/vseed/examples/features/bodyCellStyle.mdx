...
PivotTable Conditional Style - Color Scale
...
## Table conditional style - progress bar + total

Under the table total, the progress bar display range
...
## Table conditional style - set based on measure value

Table conditional styling - set based on metric values
...
PivotTable Conditional Styles - Global Styles
...
## Pivot table conditional style - set based on measure value

Pivot table conditional styles - set based on measure values
...
## Pivot table conditional style - meet conditions

Pivot table conditional style - match condition
