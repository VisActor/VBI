...
By configuring the `page` property, you can specify that the chart displays data for specific dimension values.
...
Customized player control can be achieved through the `page` attribute combined with React status management.
