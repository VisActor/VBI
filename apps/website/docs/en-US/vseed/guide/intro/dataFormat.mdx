...
VSeed supports configuring numerical formatting rules in `measures`.

- `autoFormat`: Whether to automatically format.
- `format`: Detailed formatting configuration, including type, magnification, thousandths, decimal places, unit suffixes, etc.
