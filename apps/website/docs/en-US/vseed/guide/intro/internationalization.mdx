...
VSeed has built-in internationalization support, and you can switch the language environment (such as Chinese `zh-CN`, English `en-US`, etc.) by configuring `locale`.
