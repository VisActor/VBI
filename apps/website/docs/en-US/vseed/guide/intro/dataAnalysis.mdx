...
## Axis sorting and legend sorting

VSeed provides convenient sorting configuration.

- `sort`: used to configure the sorting rules of axis data, supporting the specified sorting field `orderBy` and sorting order `order`.
