...
VSeed supports multiple chart types, and different visualization forms can be easily switched through the `chartType` attribute, including regular charts, pivot tables, etc.
