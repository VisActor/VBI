...
Scatter plots support the following visual channels:
...
Scatter plot is suitable for displaying the distribution of data, and represents the value of the data through the position of the points.

Applicable scenarios:

\- Analyze the distribution characteristics of the data, such as the central trend of the data, distribution range, outliers, etc.
...
\- at least 2 numeric fields (measurements)

\- The first measure field will be placed on the X-axis, and the remaining measures will be merged and mapped to the Y-axis

\- The measure name and dimension name will be merged and displayed as legend items

Features enabled by default:

\- Legends, coordinate axes, data point markers, tooltips, and trend lines are enabled by default.
...
The first dimension of the scatter plot is mapped to the X-axis, and the remaining dimensions will be merged with the measure name (when there are multiple measures) and displayed as legend items
...
:::note{title="Description"}
The size of the scatter chart measure, used to define the size or size range of the data points in the scatter chart

\- If the size range is a number, such as 10, it means that the size range of the data points is fixed at 10

\- If the size range is an array of length 2, such as [10, 40], it means that the size range of the data points is between 10 and 40

\- Mutually exclusive with sizeRange, has lower priority than size
...
:::note{title="Description"}
The size range of the scatter chart measure is used to define the size range of the data points in the scatter chart.

\- If the size range is an array of length 2, such as [10, 40], it means that the size range of the data points is between 10 and 40

\- If the size range is a number, such as 10, it means that the size range of the data points is fixed at 10

\- Mutually exclusive with sizeRange, has higher priority than size
...
:::note{title="Description"}
Whether to enable scatter plot animation
...
:::note{title="Description"}
Scatter plot animation parameters
...
:::note{title="Description"}
Scatter chart entry animation configuration
...
:::note{title="Description"}
Scatter chart entry effect, supporting growth and scaling animations
...
:::note{title="Description"}
Scatter plot update animation configuration
...
:::note{title="Description"}
Scatter chart update effect, support growth animation
...
:::note{title="Description"}
Scatter plot loop animation configuration
...
:::note{title="Description"}
Scatter plot atmosphere animation configuration
...
Value axis, x-axis configuration, used to define the x-axis of the chart, including the position, format, style, etc. of the x-axis.
...
Numerical label lines (including mean line, maximum value line, minimum value line, etc.) are displayed in the vertical direction. The position and style of the label line can be set. If you need to draw label lines corresponding to values such as the x-axis metric mean line, please use this configuration.
...
Numerical label lines (including mean line, maximum value line, minimum value line, etc.) are displayed in the vertical direction. The position and style of the label line can be set. If you need to draw label lines corresponding to values such as the y-axis metric mean line, please use this configuration.
...
Linear regression line configuration, including linear regression line style, etc.
...
:::note{title="Description"}
The shadow color of the graphic
...
:::note{title="Description"}
Shadow horizontal offset distance
...
:::note{title="Description"}
Shadow vertical offset distance
...
:::note{title="Description"}
Local weighted regression line configuration item



Local weighted regression line configuration items, including the style of the local weighted regression line, etc.
...
Logistic regression line configuration, including logistic regression line style, etc.
