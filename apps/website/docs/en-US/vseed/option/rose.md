...
The stacked rose chart supports the following visual channels:
...
Stacked rose chart, suitable for multi-dimensional data comparison scenarios, displays data size through sector arc and radius in polar coordinate system
...
Stacked rose chart, showing multi-dimensional data comparison relationship through polar coordinate system
