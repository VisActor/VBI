...
Circle packed charts support the following visual channels:
...
Circular packed chart, used to display hierarchical data, using the size of the circle to represent the numerical value

Applicable scenarios:

\- Display the proportion distribution of hierarchical data

\- Emphasize the inclusion relationship of data
...
\- at least 1 numeric field (metric) used to map the size of the circle
...
:::note{title="Description"}
Circular packing diagram



Circular packaging chart, showing the proportion relationship of hierarchical data
...
Measure configuration for defining the size of the circle
