...
Sunburst charts support the following visual channels:
...
Sunburst chart is used to display hierarchical data and represents the numerical value through the area of the sector.

Applicable scenarios:

\- Display the proportion distribution of multi-level data

\- Emphasis on hierarchical relationships and proportions
...
Sunburst chart, showing the proportion relationship of hierarchical data
