...
`angle`: Angle channel, supports `multiple measures`, mapped to sector angle according to measure value
...
Donut chart is suitable for displaying the proportion relationship of single-dimensional data. There is a blank area in the center to display summary information.

Applicable scenarios:

\- Need to display the overall data and the proportion of each part at the same time
...
\- All dimensions will be merged with the measure name (when there are multiple measures) and displayed as legend items.

\- All measures will be automatically merged into one measure

Features enabled by default:

\- Legends, data labels, tooltips, proportion calculations, and center text are enabled by default.
...
Donut chart, variation of pie chart with white space in the center
...
All dimensions of the donut chart will be combined with the measure name (when there are multiple measures) into one dimension, mapped to the angle of the pie chart, and displayed as a legend item.
...
All measures of the donut chart will be automatically merged into one measure, mapped to the radius of the pie chart. When there are multiple measures, the measure name will be merged with the remaining dimensions and displayed as a legend item.
