...
`primaryYAxis`: Spindle y-axis channel, supports `multiple measures`, maps measures to the spindle

`secondaryYAxis`: Secondary axis y-axis channel, supports `multiple measures`, maps measures to the secondary axis
...
Dual-axis charts are suitable for showing the comparative relationship between two measures of different magnitudes or different units, including the primary coordinate axis and the secondary coordinate axis.

Applicable scenarios:

\- Comparative analysis of measures of different magnitudes

\- Trend comparison of correlation measures

\- Composite measures such as numerical values and growth rates need to be displayed at the same time

\- Supports different types of chart combinations (such as line chart + bar chart/line chart+area chart/area chart+bar chart)
...
\- Support measure groups, the first group of measures will be placed on the (primary) left axis, and the second group of measures will be placed on the (secondary) right axis

\- The first dimension will be placed on the X-axis, and the remaining dimensions will be merged with the measure name (when there are multiple measures) and displayed as legend items.

\- Two sets of measure fields can be mapped to the left and right Y-axes respectively, and all measures in an measure group will be automatically merged into one measure.

Features enabled by default:

\- Axis, legend, data labels, and tooltips are enabled by default.
...
:::note{title="Description"}
Dual-axis chart, a composite chart showing the comparative relationship between two measures of different magnitudes
...
:::note{title="Description"}
Data set, a data set that conforms to the TidyData specification and has been aggregated, is used to define the data source and structure of the chart. The data set input by the user does not require any processing. VSeed has a powerful data reshaping function and will reshape the data by itself. The data of the dual-axis chart will eventually be converted into 2 dimensions, 1 or 2 measures (depending on whether the user has configured an measure group).

:::

**Example**
```ts
[{month:'January', value:100, growth:0.2}, {month:'February', value:150, growth:0.5}]
...
:::note{title="Description"}
Dimensions, the first dimension will be placed on the X-axis, and the remaining dimensions will be merged with the measure name (when there are multiple measures) and displayed as legend items.
...
:::note{title="Description"}
Dual Axis Chart Measure

For the measures mapped to primaryYAxis and secondaryYAxis in encoding,

You can group measures by setting the `parentId` attribute, and measures in different groups will be displayed in different subgraphs.

You can also set the `chartType` attribute to specify chart types for different measure groups.
...
\- primaryYAxis: primary y-axis of measure mapping

\- secondaryYAxis: secondary y-axis of measure mapping
...
:::note{title="Description"}
Set the chart type of this measure in dual-axis charts, only applicable to dual-axis charts
...
\- columnPercent: percentage column chart
...
:::note{title="Description"}
Used to define whether the scales of the two axes of a dual-axis chart are aligned. When there are multiple sets of measures, alignTicks can be configured as an array, and each item corresponds to whether the scales of a dual-axis chart are aligned.
...
:::note{title="Description"}
The primary Y-axis configuration of the dual-axis chart is used to define the primary Y-axis of the dual-axis chart, including the position, style, etc. of the primary Y-axis. When there are multiple groups of measures, primaryYAxis can be configured as an array, and each item corresponds to the primary Y-axis of the dual-axis chart.
...
:::note{title="Description"}
The secondary Y-axis configuration of the dual-axis chart is used to define the secondary Y-axis of the dual-axis chart, including the position, style, etc. of the secondary Y-axis. When there are multiple groups of measures, secondaryYAxis can be configured as an array, each item corresponding to the secondary Y-axis of a dual-axis chart.
...
:::note{title="Description"}
x-axis, category axis, x-axis configuration, used to define the x-axis of the chart, including the position, format, style, etc. of the x-axis.
...
:::note{title="Description"}
The background color of the chart. The background color can be a color string, such as 'red', 'blue', or hex, rgb or rgba'#ff0000', 'rgba(255,0,0,0.5)'
...
Vertical prompt box configuration is used to define the vertical prompt box of the chart, including the color of the vertical prompt box, label style, etc.



The crosshair rectangular area configuration is a type of configuration used to display a crosshair rectangular area in a chart
...
:::note{title="Description"}
Crosshair line rectangular area color
...
:::note{title="Description"}
Crosshair line rectangular area label background color
...
:::note{title="Description"}
The maximum width of the column, which can be a pixel value or a percentage string
...
:::note{title="Description"}
Under the same category, the distance between pillars can be a pixel value or a percentage string.
...
:::note{title="Description"}
Rectangular primitive style



Bar chart style configuration, used to define the bar chart style of the chart, including bar chart color, border, rounded corners, etc.
...
:::note{title="Description"}
Whether the column primitive (rectangular primitive) is visible
...
:::note{title="Description"}
Column primitive (rectangular primitive) color
...
:::note{title="Description"}
Column primitive (rectangular primitive) color transparency
...
:::note{title="Description"}
Column primitive (rectangular primitive) border color
...
:::note{title="Description"}
Column primitive (rectangular primitive) border width
...
:::note{title="Description"}
Column primitive (rectangular primitive) border style
...
:::note{title="Description"}
Column primitive (rectangular primitive) rounded corners



Column primitive (rectangular primitive) stroke transparency
...
:::note{title="Description"}
Internationalization configuration, chart language configuration, supports 'zh\- CN' and 'en\- US' two languages, in addition you can call the intl.setLocale('zh\- CN') method to set the language
