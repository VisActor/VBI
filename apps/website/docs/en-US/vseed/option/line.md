...
`y`: y-axis channel, supports `multiple measures`, mapped to y-axis according to measure value
...
Line charts are suitable for displaying the trend of data changes over time or ordered categories. Data points are connected by line segments to form a trend line.

Applicable scenarios:

\- Display the changing trend of time series data

\- Compare trends across multiple data series

\- Analyze the growth or decline patterns of data
...
:::note{title="Description"}
Line charts, suitable for showing trends in data over time or ordered categories
...
:::note{title="Description"}
Dimension, the first dimension of the line chart is mapped to the X-axis, and the remaining dimensions will be merged with the measure name (when multiple measures exist) and displayed as legend items
...
:::note{title="Description"}
Measures, all measures of the line chart will be automatically merged into one measure and mapped to the Y-axis. When there are multiple measures, the measure name will be merged with the other dimensions and displayed as a legend item.
...
Based on two selected data points, draw a difference label line and automatically calculate the difference text.
