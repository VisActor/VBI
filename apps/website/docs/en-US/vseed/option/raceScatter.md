...
It is suitable for displaying the distribution of data over time, and represents the values of two measures through the position of data points.

Applicable scenarios:

\- Analyze the distribution characteristics of data in two-dimensional space and display its dynamic changes over time

\- Show the evolution of correlations between multiple variables over time
...
\- Both the X-axis and Y-axis are numerical axes (continuous data) and support multiple measure mappings

\- Supports controlling the time dimension through the player and dynamically displaying data changes

\- Visually display the dynamic changes of data through the position changes of data points
...
:::note{title="Description"}
Dynamic scatter plot, suitable for displaying the distribution of data over time
...
:::note{title="Description"}
Data source, a data set that conforms to the TidyData specification
...
:::note{title="Description"}
Dimension, used to distinguish different data series and display legends
...
:::note{title="Description"}
Channels for dimension mapping in competition scatterplot class charts
...
:::note{title="Description"}
Measures, at least 2 measures need to be mapped to the X-axis and Y-axis respectively
...
:::note{title="Description"}
Player configuration, used to specify the time dimension, is the core configuration of dynamic scatter plots

Control the playback progress in the time dimension through the player to achieve dynamic update of data
...
:::note{title="Description"}
Sorting configuration, used to control how dimension values are sorted
...
:::note{title="Description"}
Label configuration for displaying data labels on data points
...
:::note{title="Description"}
X-axis configuration, which is a numerical axis, displays the first measure value
...
:::note{title="Description"}
Y-axis configuration, which is a numerical axis and displays the second measure value
...
:::note{title="Description"}
Crosshair configuration to show the precise location of data
...
:::note{title="Description"}
Data point style configuration, which can be in the form of a single style or an array, and supports global style or conditional style configuration.
...
:::note{title="Description"}
Numerical label lines, horizontal label lines, mark specific Y-axis values
