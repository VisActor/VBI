...
Radar chart, suitable for comparative analysis of multi-dimensional data, displays the numerical distribution of each dimension through a multi-axis coordinate system

Applicable scenarios:

\- Comprehensive performance comparison of multi-dimensional data

\- Performance evaluation of multiple objects on multiple metrics

\- Multi-dimensional feature display of classified data
...
\- The first dimension is used as each dimension axis of the radar chart, and the other dimensions are used as different series for comparison.

\- Support multiple measures to be displayed as different series

Features enabled by default:

\- The legend, radar coordinate system, data labels, tooltips, and numerical scaling are enabled by default.
...
Radar chart, showing multi-dimensional data comparison relationship through multi-axis coordinate system
...
The first dimension of the radar chart is mapped to the angle axis, and the remaining dimensions are merged with the measure name (when there are multiple measures) and displayed as legend items.
...
The measures of the radar chart will be automatically merged into one measure and mapped to the radius axis. When there are multiple measures, the measure name will be merged with the other dimensions and displayed as a legend item.
...
:::note{title="Description"}
Radar chart entry animation configuration
...
:::note{title="Description"}
Radar chart entry effect, supporting radial and zoom animations
...
:::note{title="Description"}
Radar chart update effect, supporting growth animation
