...
Side-by-side histogram supports the following visual channels:
...
Side-by-side histogram, suitable for parallel comparison scenarios of multiple measures. Multiple columns are arranged side by side to display different measure values.

Applicable scenarios:

\- Parallel comparison of multiple measures in the same dimension
...
\- Legends, coordinate axes, data labels, tooltips, and measure sorting are enabled by default.
...
:::note{title="Description"}
Side-by-side histogram, suitable for multi-measure parallel comparison scenarios
...
:::note{title="Description"}
Dimension, the first dimension is mapped to the X-axis, and the remaining dimensions will be merged with the measure name (when there are multiple measures) and displayed as legend items.
...
:::note{title="Description"}
Measures, all measures of the side-by-side histogram will be automatically merged into one measure and mapped to the Y-axis. When there are multiple measures, the measure name will be merged with the other dimensions and displayed as a legend item.
...
:::note{title="Description"}
Rectangle primitive style, parallel column chart style configuration, used to define the parallel column chart style of the chart, including the color, border, rounded corners, etc. of the parallel column chart.
