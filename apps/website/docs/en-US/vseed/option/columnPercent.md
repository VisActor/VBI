...
Percentage bar chart, suitable for scenarios showing the proportion relationship of various categories. The Y-axis displays the data proportion in the form of percentage.

Applicable scenarios:

\- Comparison of proportions of different categories of data

\- Composition analysis of multi-dimensional data

\- The proportion change trend of time series
...
Percentage bar chart, showing the relationship between the proportion of each category of data in the form of percentages
...
The percentage histogram measures will be automatically merged into one measure and mapped to the Y-axis. When there are multiple measures, the measure names will be merged with the other dimensions and displayed as legend items.
...
:::note{title="Description"}
Side-by-side column chart Stacked rounded corners
...
:::note{title="Description"}
Rectangular primitive style, used to define the rectangular primitive style of the chart, including the color, border, rounded corners, etc. of the rectangular primitive.
