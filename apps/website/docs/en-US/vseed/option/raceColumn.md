...
Suitable for displaying the ranking of data over time, with columns arranged vertically

Applicable scenarios:

\- When the data item name is long

\- It is necessary to visually compare the numerical sizes of different categories and display their changes over time.

\- Display the trend of time series data and dynamically update the column sorting
...
\- The X-axis is the category axis (categorical data), showing dimension values

\- The Y-axis is a numerical axis (continuous data), showing measure values

\- Supports controlling the time dimension through the player and dynamically displaying data changes

\- The columns are dynamically sorted according to their numerical value in the animation
...
:::note{title="Description"}
Dynamic histogram, suitable for displaying the ranking of data over time
...
:::note{title="Description"}
A data set that conforms to the TidyData specification and has been aggregated
...
The first dimension is mapped to the player, and the second dimension is mapped to the X-axis
...
All measures of the dynamic histogram will be automatically merged into one measure and mapped to the Y-axis. When there are multiple measures, the measure name will be merged with the other dimensions and displayed as a legend item.
...
:::note{title="Description"}
Player configuration, used to specify the time dimension, is the core configuration of dynamic histograms

Control the playback progress in the time dimension through the player to achieve dynamic updates and sorting changes of data
...
:::note{title="Description"}
Sorting configuration, dynamic histograms usually need to be dynamically sorted based on numerical values
...
:::note{title="Description"}
Paging configuration, used to handle scenarios with large amounts of data
...
:::note{title="Description"}
Color configuration to distinguish different dimensions or measures
...
:::note{title="Description"}
Label configuration for displaying data labels on columns
...
:::note{title="Description"}
Prompt information configuration, used to display detailed information when the mouse hovers
...
:::note{title="Description"}
Frame selection configuration, used to support frame selection interaction
...
:::note{title="Description"}
X-axis configuration, which is the category axis, displays dimension values, and the columns are arranged vertically
...
:::note{title="Description"}
Y-axis configuration, which is a numerical axis and displays measure values
...
:::note{title="Description"}
Crosshair configuration for displaying precise values of data
...
:::note{title="Description"}
Maximum width configuration of rectangle
...
:::note{title="Description"}
Column style configuration, which can be a single style or an array
...
:::note{title="Description"}
Label point configuration for adding markers on specific data points
...
:::note{title="Description"}
Numerical label line, vertical label line, marks specific X-axis value
...
:::note{title="Description"}
Dimension value label line, horizontal label line, mark specific Y-axis category
...
:::note{title="Description"}
Callout area configuration for highlighting specific data ranges
