...
Suitable for displaying the trend of data changes over time, connecting data points through line segments to form a trend line

Applicable scenarios:

\- Show trends in multiple data series over time

\- Compare the growth or decline patterns of different categories

\- Observe the fluctuation of data in the time dimension
...
\- The X-axis is usually a time axis or a category axis, showing dimension values

\- The Y-axis is a numerical axis, showing measure values

\- Supports controlling the time dimension through the player and dynamically displaying the extension process of the polyline
...
:::note{title="Description"}
Dynamic line chart, suitable for showing the trend of data changes over time
...
:::note{title="Description"}
Player configuration, used to specify the time dimension, the core configuration of dynamic line charts
...
:::note{title="Description"}
x-axis configuration, which is the category axis and displays dimension values
...
:::note{title="Description"}
Vertical prompt line configuration
...
:::note{title="Description"}
Point primitive style configuration
...
:::note{title="Description"}
Line primitive style configuration
...
:::note{title="Description"}
Dimension value label line configuration
...
:::note{title="Description"}
Numeric label line configuration
