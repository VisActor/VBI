...
Suitable for displaying ranking changes in data over time
...
:::note{title="Description"}
Dynamic bar chart, suitable for displaying the ranking of data over time
...
\- player: supports mapping multiple dimensions to playback channels
...
:::note{title="Description"}
Player configuration, used to specify the time dimension, the core configuration of dynamic bar charts
...
:::note{title="Description"}
Sorting configuration, dynamic bar charts usually need to be dynamically sorted based on numerical values
...
:::note{title="Description"}
x-axis configuration, which is a numerical axis and displays measure values
...
:::note{title="Description"}
Y-axis configuration, which is the category axis, displays dimension values, and the columns are arranged vertically
...
:::note{title="Description"}
Horizontal prompt box configuration
