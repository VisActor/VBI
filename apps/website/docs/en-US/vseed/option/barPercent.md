...
Percentage bar chart, suitable for scenarios where the proportion of each category is displayed horizontally. The X-axis displays the data proportion in the form of a percentage.
...
\- Scenario where ranking and proportion are displayed at the same time
...
\- The sum of the proportions of all categories is 100%

\- Support multi-series stacking to display proportional relationships
...
:::note{title="Description"}
Percentage bar chart, showing the relationship between the proportion of each category of data in the form of horizontal percentages
...
:::note{title="Description"}
Dimensions, the first dimension will be placed on the Y-axis, and the remaining dimensions will be merged with the measure name (when there are multiple measures) and displayed as legend items.
...
:::note{title="Description"}
Measures will be automatically merged into one measure and mapped to the X-axis. When there are multiple measures, the measure name will be merged with the other dimensions and displayed as a legend item.
