...
VSeed hỗ trợ nhiều loại biểu đồ và bạn có thể dễ dàng chuyển đổi giữa các dạng trực quan khác nhau thông qua thuộc tính `chartType`, bao gồm biểu đồ thông thường, bảng tổng hợp, v.v.
