...
VSeed cung cấp cấu hình sắp xếp thuận tiện.

- `sort`: Dùng để cấu hình quy tắc sắp xếp dữ liệu trục, hỗ trợ chỉ định trường sắp xếp `orderBy`và thứ tự sắp xếp `order`.
