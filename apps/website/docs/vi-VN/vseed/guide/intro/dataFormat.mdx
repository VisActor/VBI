...
VSeed hỗ trợ định cấu hình quy tắc định dạng số trong `measures`.

- `autoFormat`: Có tự động định dạng hay không.
- `format`: Cấu hình định dạng chi tiết, bao gồm loại, độ phóng đại, phần nghìn, chữ số thập phân, hậu tố đơn vị, v.v.
