...
:::tip
Thông thường, việc xử lý dữ liệu biểu đồ rất tốn thời gian. VSeed hỗ trợ xử lý dữ liệu phân chia và hiển thị dữ liệu. `build`cung cấp `buildAdvanced`và `buildSpec`cho việc xây dựng riêng biệt.
:::
...
Ví dụ sau đây cho thấy cách sử dụng quy trình xây dựng tách rời với thành phần React.
