...
VSeed có hỗ trợ quốc tế hóa tích hợp và bạn có thể chuyển đổi môi trường ngôn ngữ (chẳng hạn như tiếng Trung `zh-CN`, tiếng Anh `en-US`, v.v.) bằng cách định cấu hình `locale`.
