...
:::info
Các loại dữ liệu và biểu đồ được tách rời hoàn toàn và VSeed luôn có thể định hình lại chúng bất kể có bao nhiêu thứ nguyên hoặc số liệu. Cái giá có thể là ngữ nghĩa kém của biểu đồ, nhưng nó đáng giá.
:::

Ví dụ bên dưới minh họa sự kết hợp tự do giữa các cấu trúc khác nhau của `dataset`và `chartType`khác nhau. Bạn có thể nhấp vào nút bên dưới để chuyển đổi tập dữ liệu và loại biểu đồ cũng như quan sát cách VSeed tự động điều chỉnh.
