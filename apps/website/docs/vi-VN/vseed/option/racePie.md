...
:::note{title="Mô tả"}
Biểu đồ hình tròn cuộc đua

Nó phù hợp để hiển thị mối quan hệ tỷ lệ của dữ liệu theo thời gian. Tỷ trọng của mỗi hạng mục được thể hiện bằng quy mô của khu vực ngành.

Các tình huống áp dụng:

\-Hiển thị tỷ lệ phân bổ dữ liệu phân loại thay đổi theo thời gian

\- Nhấn mạnh vào sự phát triển của mối quan hệ giữa toàn bộ và các bộ phận của dữ liệu theo chiều thời gian

\-Quan sát sự biến động về tỷ trọng của các loại khác nhau trong tổng số

:::

:::note{title="Note"}
Biểu đồ hình tròn động:

\-Giá trị chỉ số ánh xạ góc, giá trị thứ nguyên ánh xạ màu

\-Hỗ trợ kiểm soát kích thước thời gian thông qua trình phát và hiển thị động các thay đổi tỷ lệ

\-Khu vực ngành được điều chỉnh linh hoạt khi dữ liệu thay đổi
...
:::note{title="Mô tả"}
Biểu đồ hình tròn động, phù hợp để hiển thị mối quan hệ tỷ lệ thay đổi dữ liệu theo thời gian
...
:::note{title="Mô tả"}
Cấu hình trình phát, được sử dụng để chỉ định thứ nguyên thời gian, cấu hình cốt lõi của biểu đồ hình tròn động
