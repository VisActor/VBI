...
Biểu đồ kênh hỗ trợ các kênh trực quan sau:

`size`: Kích thước kênh, hỗ trợ `nhiều chỉ số`, được ánh xạ tới chiều rộng kênh theo giá trị chỉ số
...
:::note{title="Mô tả"}
Biểu đồ phễu, được sử dụng để hiển thị mối quan hệ tỷ lệ của dữ liệu một chiều

Các tình huống áp dụng:

Các tình huống áp dụng biểu đồ kênh:

\- Phù hợp để phân tích các quy trình với nhiều bước liên tục, chuẩn hóa và thể hiện rõ ràng tình trạng mất hoặc chuyển đổi dữ liệu trong từng link
...
Biểu đồ hình phễu, thể hiện mối quan hệ tỷ lệ của dữ liệu một chiều
...
Tất cả các thứ nguyên của biểu đồ kênh sẽ được kết hợp với tên chỉ số (khi có nhiều chỉ số) thành một thứ nguyên và hiển thị dưới dạng mục chú giải
...
Tất cả các chỉ số của biểu đồ kênh sẽ được tự động hợp nhất thành một chỉ số. Khi có nhiều chỉ số, tên chỉ số sẽ được hợp nhất với các kích thước còn lại và hiển thị dưới dạng mục chú giải.
...
:::note{title="Mô tả"}
Cấu hình màu gradient tuyến tính, được sử dụng để xác định bảng màu của biểu đồ
...
:::note{title="Mô tả"}
Cấu hình chú giải màu được sử dụng để xác định chú giải của biểu đồ, bao gồm vị trí, định dạng, kiểu, v.v. của chú giải.
