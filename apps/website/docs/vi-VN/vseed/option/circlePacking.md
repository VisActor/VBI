...
Biểu đồ đóng gói vòng tròn hỗ trợ các kênh trực quan sau:
...
:::note{title="Mô tả"}
Biểu đồ đóng gói hình tròn, dùng để hiển thị dữ liệu có thứ bậc, sử dụng kích thước của hình tròn để biểu thị giá trị số

Các tình huống áp dụng:

\- Hiển thị tỷ lệ phân bổ dữ liệu phân cấp

\- Nhấn mạnh mối quan hệ bao hàm của dữ liệu
...
\- ít nhất 1 trường số (số liệu) được sử dụng để ánh xạ chiều của vòng tròn
...
:::note{title="Mô tả"}
Sơ đồ đóng gói hình tròn



Biểu đồ bao bì hình tròn, thể hiện mối quan hệ tỷ lệ của dữ liệu phân cấp
...
Cấu hình chỉ số để xác định kích thước của vòng tròn
