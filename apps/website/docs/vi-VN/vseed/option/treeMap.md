...
Sơ đồ cây hình chữ nhật hỗ trợ các kênh trực quan sau:

`color`: kênh màu, hỗ trợ `nhiều chiều`hoặc `một chỉ số`

`label`: Tag kênh, ủng hộ `nhiều chiều`và `nhiều chỉ số`

`tooltip`: Kênh nhắc nhở, hỗ trợ `nhiều chiều`và `nhiều chỉ số`

:::

:::note{title="Mô tả"}
Sơ đồ cây hình chữ nhật, dùng để hiển thị dữ liệu có thứ bậc, thể hiện kích thước bằng số thông qua kích thước của diện tích hình chữ nhật

Các tình huống áp dụng:

\- Hiển thị tỷ lệ phân bổ dữ liệu phân cấp
...
\- ít nhất 1 trường số (đo lường) được sử dụng để ánh xạ khu vực

\-Ít nhất 1 trường chiều được sử dụng để phân chia thứ bậc
...
:::note{title="Mô tả"}
Sơ đồ cây hình chữ nhật



Sơ đồ cây hình chữ nhật, thể hiện mối quan hệ tỷ lệ của dữ liệu phân cấp
...
Tập dữ liệu tổng hợp tuân thủ đặc tả TidyData và được dùng để xác định nguồn dữ liệu và cấu trúc của biểu đồ
...
Cấu hình thứ nguyên, được sử dụng để xác định cấu trúc phân cấp của dữ liệu
...
\- phân cấp: hỗ trợ ánh xạ nhiều chiều tới các kênh phân cấp
...
:::tip{title="Tip"}
Kích thước đầu tiên sẽ được ánh xạ trực tiếp tới kênh màu
...
Cấu hình chỉ số để xác định quy mô (diện tích) của ngành
...
\- size: Chỉ số được ánh xạ tới kênh kích thước, được sử dụng để hiển thị diện tích hoặc kích thước của biểu đồ như sơ đồ cây.
...
Tên trường dùng để chỉ định phân trang, phải là thứ nguyên
...
Cấu hình ngôn ngữ biểu đồ, hỗ trợ ngôn ngữ 'zh\-CN' và 'en\-US'
