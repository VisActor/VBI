...
:::note{title="Mô tả"}
Biểu đồ vùng phù hợp để hiển thị xu hướng và mối quan hệ tích lũy của dữ liệu theo thời gian và tăng cường so sánh dữ liệu bằng cách điền vào các vùng. trục X là trục danh mục (dữ liệu phân loại) và trục Y là trục số (dữ liệu liên tục).

Các tình huống áp dụng:

\-Hiển thị những thay đổi về xu hướng trong một chuỗi dữ liệu

\- Nhấn mạnh vào tác động tích lũy của tổng số tiền theo thời gian

\- So sánh tổng số khác biệt trong nhiều chuỗi dữ liệu
...
\- Trường thứ nguyên đầu tiên được ánh xạ tới trục X và các trường thứ nguyên còn lại sẽ được hợp nhất với tên chỉ số (khi có nhiều chỉ số) và hiển thị dưới dạng mục chú giải.

\- Tất cả các chỉ số sẽ được tự động hợp nhất thành một chỉ số

Các tính năng được bật theo mặc định:

\- Mô-đun cho phép xếp chồng

\-Chú giải, trục tọa độ, vùng điền, nhãn dữ liệu và thông tin lời nhắc được bật theo mặc định.
...
Biểu đồ vùng, một loại biểu đồ hiển thị xu hướng dữ liệu và mối quan hệ tích lũy.
...
Một tập dữ liệu tổng hợp tuân thủ đặc tả TidyData được dùng để xác định nguồn dữ liệu và cấu trúc của biểu đồ. Tập dữ liệu do người dùng nhập vào không yêu cầu bất kỳ xử lý nào. VSeed có chức năng định hình lại dữ liệu mạnh mẽ và sẽ tự định hình lại dữ liệu. Dữ liệu của biểu đồ vùng cuối cùng sẽ được chuyển đổi thành 2 chiều và 1 chỉ số.
...
**Ví dụ**
```ts
[{id: 'tháng', bí danh: 'tháng'}, {id: 'năm', bí danh: 'năm'}]
...
Các chỉ số của biểu đồ vùng sẽ tự động được hợp nhất thành một chỉ số và ánh xạ tới trục Y. Tên chỉ số sẽ được hợp nhất với các thứ nguyên khác và hiển thị dưới dạng mục chú giải.
...
:::note{title="Mô tả"}
Có bật hoạt ảnh biểu đồ đường/khu vực hay không
...
:::note{title="Mô tả"}
Tham số hoạt ảnh biểu đồ đường/khu vực
...
:::note{title="Mô tả"}
Cấu hình hoạt hình mục nhập biểu đồ đường/khu vực
...
:::note{title="Mô tả"}
Hiệu ứng nhập biểu đồ đường/khu vực, hỗ trợ tải và tăng trưởng hoạt ảnh
...
:::note{title="Mô tả"}
Cấu hình hoạt ảnh cập nhật biểu đồ đường/khu vực
...
:::note{title="Mô tả"}
Hiệu ứng cập nhật biểu đồ đường/khu vực, hỗ trợ hoạt ảnh tăng trưởng
...
:::note{title="Mô tả"}
Cấu hình hoạt ảnh chu kỳ biểu đồ đường/khu vực
...
:::note{title="Mô tả"}
Hiệu ứng vòng lặp biểu đồ đường/khu vực
...
:::note{title="Mô tả"}
Cấu hình hoạt hình bầu không khí biểu đồ đường/khu vực
...
Trục danh mục, cấu hình trục X, được sử dụng để xác định trục X của biểu đồ, bao gồm vị trí, định dạng, kiểu, v.v. của trục X.
...
Dựa trên hai điểm dữ liệu đã chọn, vẽ một dòng nhãn chênh lệch và tự động tính toán văn bản chênh lệch.
