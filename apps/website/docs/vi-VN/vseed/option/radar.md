...
:::note{title="Mô tả"}
Biểu đồ radar, phù hợp để phân tích so sánh dữ liệu đa chiều, hiển thị phân bố số của từng chiều thông qua hệ tọa độ đa trục

Các tình huống áp dụng:

\- So sánh hiệu suất toàn diện của dữ liệu đa chiều

\-Đánh giá hiệu suất của nhiều đối tượng trên nhiều số liệu

\- Tính năng hiển thị đa chiều của dữ liệu đã được phân loại
...
\-Thứ nguyên đầu tiên được sử dụng làm trục kích thước của biểu đồ radar và các thứ nguyên khác được sử dụng làm chuỗi khác nhau để so sánh.

\-Hỗ trợ nhiều chỉ số được hiển thị dưới dạng các chuỗi khác nhau

Các tính năng được bật theo mặc định:

\-Chú giải, hệ tọa độ radar, nhãn dữ liệu, thông tin nhắc nhở và tỷ lệ số được bật theo mặc định.
...
Biểu đồ radar, thể hiện mối quan hệ so sánh dữ liệu đa chiều thông qua hệ tọa độ đa trục
...
Kích thước đầu tiên của biểu đồ radar được ánh xạ tới trục góc và các kích thước còn lại được hợp nhất với tên chỉ số (khi có nhiều chỉ số) và hiển thị dưới dạng mục chú giải.
...
Các chỉ số của biểu đồ radar sẽ được tự động hợp nhất thành một chỉ số và ánh xạ tới trục bán kính. Khi có nhiều chỉ số, tên chỉ số sẽ được hợp nhất với các thứ nguyên khác và hiển thị dưới dạng mục chú giải.
...
:::note{title="Mô tả"}
Có bật hoạt ảnh biểu đồ radar hay không
...
:::note{title="Mô tả"}
Thông số hoạt hình biểu đồ radar
...
:::note{title="Mô tả"}
Cấu hình hoạt hình mục nhập biểu đồ radar
...
:::note{title="Mô tả"}
Hiệu ứng nhập biểu đồ radar, hỗ trợ hoạt ảnh xuyên tâm và thu phóng
...
:::note{title="Mô tả"}
Cấu hình hoạt ảnh cập nhật biểu đồ radar
...
:::note{title="Mô tả"}
Hiệu ứng cập nhật biểu đồ radar, hỗ trợ hoạt ảnh tăng trưởng
...
:::note{title="Mô tả"}
Cấu hình hoạt hình vòng lặp biểu đồ radar
...
:::note{title="Mô tả"}
Cấu hình hoạt hình bầu không khí biểu đồ radar
