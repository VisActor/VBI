...
Biểu đồ hoa hồng được nhóm lại hỗ trợ các kênh trực quan sau:

`angle`: Kênh góc, hỗ trợ `nhiều chiều`, ánh xạ tới trục góc theo giá trị thứ nguyên

`radius`: Bán kính kênh, hỗ trợ `nhiều chỉ số`, ánh xạ tới trục bán kính theo giá trị chỉ số
...
:::note{title="Mô tả"}
Biểu đồ hoa hồng được nhóm lại, phù hợp với kịch bản so sánh dữ liệu đa chiều, thể hiện kích thước dữ liệu qua cung và bán kính ngành trong hệ tọa độ cực

Các tình huống áp dụng:

\-So sánh phân bố của dữ liệu đa chiều

\-So sánh sức mạnh của dữ liệu theo chu kỳ

\- Giá trị số và tỷ lệ của dữ liệu đã phân loại được hiển thị cùng lúc
...
\- Kích thước đầu tiên sẽ được đặt trên trục góc, các kích thước còn lại sẽ được hợp nhất với tên chỉ số (khi có nhiều chỉ số) và hiển thị dưới dạng mục chú giải

\- Tất cả các chỉ số sẽ được tự động hợp nhất thành một chỉ số

Các tính năng được bật theo mặc định:

\-Chú giải, hệ tọa độ cực, nhãn dữ liệu, thông tin nhắc nhở và chia tỷ lệ số được bật theo mặc định.
...
:::note{title="Mô tả"}
Biểu đồ hoa hồng được nhóm



Biểu đồ hoa hồng được nhóm lại, thể hiện mối quan hệ so sánh dữ liệu đa chiều thông qua hệ tọa độ cực
...
Một tập dữ liệu tổng hợp tuân thủ đặc tả TidyData được dùng để xác định nguồn dữ liệu và cấu trúc của biểu đồ. Tập dữ liệu do người dùng nhập vào không yêu cầu bất kỳ xử lý nào. VSeed có chức năng định hình lại dữ liệu mạnh mẽ và sẽ tự định hình lại dữ liệu. Dữ liệu biểu đồ hoa hồng cuối cùng sẽ được chuyển đổi thành 2 chiều và 1 chỉ số.
...
Kích thước đầu tiên của biểu đồ hoa hồng được ánh xạ tới trục góc và các kích thước còn lại được kết hợp với tên chỉ số (khi có nhiều chỉ số) và được hiển thị dưới dạng mục chú giải.
...
\- góc: hỗ trợ ánh xạ nhiều chiều tới các kênh góc
...
Các chỉ số của biểu đồ hoa hồng sẽ tự động được hợp nhất thành một chỉ số và ánh xạ tới trục bán kính. Khi có nhiều chỉ số, tên chỉ số sẽ được hợp nhất với các thứ nguyên khác và hiển thị dưới dạng mục chú giải.
...
\- bán kính: bán kính ánh xạ chỉ số
...
:::note{title="Mô tả"}
Phương pháp bố cục nhãn, chỉ hiệu quả đối với biểu đồ hình tròn và biểu đồ bánh rán và khi `labelPosition`là `outside`

\- arc: nhãn bố trí theo hình cung

\- labelLine: Căn chỉnh cả hai đầu của nhãn, kết nối các phần gốc và nhãn thông qua các đường dẫn

\- edge: Căn chỉnh hai đầu của nhãn, nối các hình gốc và nhãn hình quạt thông qua các đường dẫn, và sát các cạnh của cả hai đầu của biểu đồ
...
:::note{title="Mô tả"}
Có bật biểu đồ tròn/biểu đồ vòng/hoạt ảnh biểu đồ hoa hồng hay không
...
:::note{title="Mô tả"}
Thông số hoạt hình biểu đồ hình tròn/biểu đồ vòng/biểu đồ hoa hồng
...
:::note{title="Mô tả"}
Cấu hình hoạt ảnh mục nhập biểu đồ hình tròn/biểu đồ vòng/biểu đồ hoa hồng
...
:::note{title="Mô tả"}
Biểu đồ hình tròn/biểu đồ vòng/hiệu ứng nhập biểu đồ hoa hồng, hỗ trợ hoạt ảnh xuyên tâm và thu phóng
...
:::note{title="Mô tả"}
Cấu hình hoạt ảnh cập nhật biểu đồ hình tròn/biểu đồ vòng/biểu đồ hoa hồng
...
:::note{title="Mô tả"}
Hiệu ứng cập nhật biểu đồ hình tròn/biểu đồ vòng/biểu đồ hoa hồng, hỗ trợ hoạt ảnh xuyên tâm
...
:::note{title="Mô tả"}
Cấu hình hoạt hình chu kỳ biểu đồ hình tròn/biểu đồ vòng/biểu đồ hoa hồng
...
:::note{title="Mô tả"}
Biểu đồ tròn/biểu đồ vòng/hiệu ứng vòng lặp biểu đồ hoa hồng
...
:::note{title="Mô tả"}
Cấu hình hoạt hình bầu không khí biểu đồ hình tròn/biểu đồ vòng/biểu đồ hoa hồng
