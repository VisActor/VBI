...
`x`: kênh trục X, hỗ trợ `nhiều chiều`, ánh xạ tới trục X theo giá trị thứ nguyên

`y`: kênh trục Y, hỗ trợ `nhiều chỉ số`, ánh xạ tới trục Y theo giá trị chỉ số
...
:::note{title="Mô tả"}
Biểu đồ đường phù hợp để hiển thị xu hướng thay đổi dữ liệu theo thời gian hoặc theo danh mục được sắp xếp. Các điểm dữ liệu được kết nối bằng các đoạn đường để tạo thành đường xu hướng.

Các tình huống áp dụng:

\- Hiển thị xu hướng thay đổi của dữ liệu chuỗi thời gian

\- So sánh xu hướng trên nhiều chuỗi dữ liệu

\-Phân tích các mô hình tăng trưởng hoặc suy giảm của dữ liệu
...
\- ít nhất 1 trường số (số liệu)

\- Kích thước đầu tiên sẽ được đặt trên trục X và các kích thước còn lại sẽ được hợp nhất với tên chỉ số (khi có nhiều chỉ số) và hiển thị dưới dạng mục chú giải
...
:::note{title="Mô tả"}
Biểu đồ đường, phù hợp để hiển thị xu hướng dữ liệu theo thời gian hoặc các danh mục được sắp xếp
...
:::note{title="Mô tả"}
Thứ nguyên, thứ nguyên đầu tiên của biểu đồ đường được ánh xạ tới trục X và các thứ nguyên còn lại sẽ được hợp nhất với tên chỉ số (khi tồn tại nhiều chỉ số) và hiển thị dưới dạng mục chú giải
...
:::note{title="Mô tả"}
Các chỉ số, tất cả các chỉ số của biểu đồ đường sẽ được tự động hợp nhất thành một chỉ số và ánh xạ tới trục Y. Khi có nhiều chỉ số, tên chỉ số sẽ được hợp nhất với các thứ nguyên khác và hiển thị dưới dạng mục chú giải.
