...
\- cấu hình trường khuyến nghị: `2`chỉ số, `1`chiều
...
Các biểu đồ phân tán hỗ trợ các kênh hình ảnh sau:
...
:::note{title="Mô tả"}
Biểu đồ phân tán phù hợp để hiển thị phân bố dữ liệu và thể hiện giá trị của dữ liệu thông qua vị trí của các điểm.

Các tình huống áp dụng:

\-Phân tích các đặc điểm phân phối của dữ liệu, chẳng hạn như xu hướng trung tâm của dữ liệu, phạm vi phân phối, các ngoại lệ, v.v.
...
\- ít nhất 2 trường số (số đo)

\- Trường chỉ số đầu tiên sẽ được đặt trên trục X và các chỉ số còn lại sẽ được hợp nhất và ánh xạ tới trục Y

\-Tên chỉ số và tên thứ nguyên sẽ được hợp nhất và hiển thị dưới dạng mục chú giải

Các tính năng được bật theo mặc định:

\-Chú giải, trục tọa độ, điểm đánh dấu dữ liệu, thông tin nhắc nhở và đường xu hướng được bật theo mặc định.
...
Một tập dữ liệu tổng hợp tuân thủ đặc tả TidyData được dùng để xác định nguồn dữ liệu và cấu trúc của biểu đồ. Tập dữ liệu do người dùng nhập vào không yêu cầu bất kỳ xử lý nào. VSeed có chức năng định hình lại dữ liệu mạnh mẽ và sẽ tự định hình lại dữ liệu. Dữ liệu của biểu đồ đường cuối cùng sẽ được chuyển đổi thành 2 chiều và 1 chỉ số.
...
Kích thước đầu tiên của biểu đồ phân tán được ánh xạ tới trục X và các kích thước còn lại sẽ được hợp nhất với tên chỉ số (khi có nhiều chỉ số) và hiển thị dưới dạng mục chú giải
...
[
  {
id: 'lợi nhuận', bí danh: 'lợi nhuận', mã hóa: 'xAxis'
  },
  {
    id: 'bán hàng', bí danh: 'bán hàng', mã hóa: 'yAxis'
  }
]
...
\- xAxis: trục X của ánh xạ chỉ số

\- yAxis: trục Y của ánh xạ chỉ số

\- size: kích thước của bản đồ chỉ số
...
:::note{title="Mô tả"}
Kích thước của chỉ số biểu đồ phân tán, được sử dụng để xác định kích thước hoặc phạm vi kích thước của các điểm dữ liệu trong biểu đồ phân tán

\- Nếu phạm vi kích thước là một số, chẳng hạn như 10, điều đó có nghĩa là phạm vi kích thước của các điểm dữ liệu được cố định ở 10

\- Nếu phạm vi kích thước là một mảng có độ dài 2, chẳng hạn như [10, 40], điều đó có nghĩa là phạm vi kích thước của các điểm dữ liệu nằm trong khoảng từ 10 đến 40

\- Loại trừ lẫn nhau với sizeRange, có mức độ ưu tiên thấp hơn kích thước
...
:::note{title="Mô tả"}
Phạm vi kích thước của chỉ số biểu đồ phân tán được sử dụng để xác định phạm vi kích thước của các điểm dữ liệu trong biểu đồ phân tán.

\- Nếu phạm vi kích thước là một mảng có độ dài 2, chẳng hạn như [10, 40], điều đó có nghĩa là phạm vi kích thước của các điểm dữ liệu nằm trong khoảng từ 10 đến 40

\- Nếu phạm vi kích thước là một số, chẳng hạn như 10, điều đó có nghĩa là phạm vi kích thước của các điểm dữ liệu được cố định ở 10

\- Loại trừ lẫn nhau với sizeRange, có mức độ ưu tiên cao hơn kích thước
...
:::note{title="Mô tả"}
Có bật hoạt ảnh phân tán hay không
...
:::note{title="Mô tả"}
Thông số hoạt ảnh biểu đồ phân tán
...
:::note{title="Mô tả"}
Cấu hình hoạt hình mục nhập biểu đồ phân tán
...
:::note{title="Mô tả"}
Hiệu ứng nhập biểu đồ phân tán, hỗ trợ hoạt ảnh tăng trưởng và chia tỷ lệ
...
:::note{title="Mô tả"}
Cấu hình hoạt hình cập nhật âm mưu phân tán
...
:::note{title="Mô tả"}
Hiệu ứng cập nhật biểu đồ phân tán, hỗ trợ hoạt ảnh tăng trưởng
...
:::note{title="Mô tả"}
Cấu hình hoạt hình vòng lặp âm mưu phân tán
...
:::note{title="Mô tả"}
Hiệu ứng vòng lặp biểu đồ phân tán
...
:::note{title="Mô tả"}
Cấu hình hoạt hình bầu không khí phân tán
...
Trục giá trị, cấu hình trục X, được sử dụng để xác định trục X của biểu đồ, bao gồm vị trí, định dạng, kiểu, v.v. của trục X.
...
Trục giá trị, cấu hình trục Y, được sử dụng để xác định trục Y của biểu đồ, bao gồm vị trí, định dạng, kiểu, v.v. của trục Y.
...
Khi di chuột qua biểu đồ sẽ hiển thị dòng nhắc dọc
...
:::note{title="Mô tả"}
Dán nhãn các đường thẳng đứng



Các dòng nhãn số (bao gồm dòng trung bình, dòng giá trị lớn nhất, dòng giá trị nhỏ nhất, v.v.) được hiển thị theo hướng dọc. Vị trí và kiểu dáng của dòng nhãn có thể được đặt. Nếu bạn cần vẽ các đường nhãn tương ứng với các giá trị như đường trung bình số liệu trục X, vui lòng sử dụng cấu hình này.
...
:::note{title="Mô tả"}
Dán nhãn các đường ngang



Các dòng nhãn số (bao gồm dòng trung bình, dòng giá trị lớn nhất, dòng giá trị nhỏ nhất, v.v.) được hiển thị theo hướng dọc. Vị trí và kiểu dáng của dòng nhãn có thể được đặt. Nếu bạn cần vẽ các đường nhãn tương ứng với các giá trị như đường trung bình số liệu trục Y, vui lòng sử dụng cấu hình này.
...
Cấu hình đường hồi quy tuyến tính, bao gồm kiểu đường hồi quy tuyến tính, v.v.
...
Được sử dụng để đặt màu của đường hồi quy. Nếu không được đặt, màu chính của biểu đồ sẽ được sử dụng theo mặc định.
...
Dùng để thiết lập độ rộng của đường hồi quy, đơn vị là pixel, giá trị mặc định là 1
...
Được sử dụng để đặt kiểu của đường hồi quy, chẳng hạn như đường liền nét, đường đứt nét, v.v. Giá trị mặc định là đường liền nét
...
:::note{title="Mô tả"}
Văn bản nhãn dòng hồi quy

Văn bản nhãn được sử dụng để đặt đường hồi quy. Một chuỗi trống có nghĩa là không có nhãn nào được hiển thị.
...
:::note{title="Mô tả"}
Cài đặt giá trị khoảng tin cậy, mức độ tin cậy mặc định là 95%
...
:::note{title="Mô tả"}
Tính minh bạch của khoảng tin cậy
...
:::note{title="Mô tả"}
Mục cấu hình dòng hồi quy có trọng số cục bộ



Các mục cấu hình đường hồi quy có trọng số cục bộ, bao gồm kiểu của đường hồi quy có trọng số cục bộ, v.v.
...
Cấu hình đường hồi quy đa thức, bao gồm thứ tự đa thức, kiểu đường hồi quy, v.v.
...
Cấu hình đường hồi quy logistic, bao gồm kiểu đường hồi quy logistic, v.v.
