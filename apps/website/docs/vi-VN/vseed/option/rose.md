...
:::note{title="Mô tả"}
Biểu đồ hoa hồng xếp chồng, phù hợp với kịch bản so sánh dữ liệu đa chiều, hiển thị kích thước dữ liệu qua cung và bán kính ngành trong hệ tọa độ cực
...
:::note{title="Mô tả"}
biểu đồ hoa hồng xếp chồng lên nhau



Biểu đồ hoa hồng xếp chồng, thể hiện mối quan hệ so sánh dữ liệu đa chiều thông qua hệ tọa độ cực
