...
:::note{title="Mô tả"}
Biểu đồ Sunburst được sử dụng để hiển thị dữ liệu phân cấp và biểu thị giá trị số thông qua khu vực của ngành.

Các tình huống áp dụng:

\- Hiển thị tỷ lệ phân bổ dữ liệu đa cấp

\- Nhấn mạnh vào mối quan hệ và tỷ lệ thứ bậc
...
Biểu đồ Sunburst, thể hiện mối quan hệ tỷ lệ của dữ liệu phân cấp
