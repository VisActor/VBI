...
Biểu đồ phần trăm khu vực hỗ trợ các kênh trực quan sau:
...
:::note{title="Mô tả"}
Biểu đồ phần trăm diện tích, phù hợp để thể hiện xu hướng thay đổi tỷ lệ đa danh mục theo thời gian. trục Y biểu thị mối quan hệ tỷ lệ dưới dạng phần trăm.

Các tình huống áp dụng:

\- Phân tích sự thay đổi thành phần của chuỗi thời gian

\- So sánh xu hướng tỷ lệ đa danh mục

\- Tỷ lệ tích lũy và tỷ lệ của một danh mục được hiển thị cùng một lúc
...
:::note{title="Mô tả"}
Biểu đồ phần trăm diện tích



Biểu đồ vùng tỷ lệ phần trăm, thể hiện sự thay đổi về tỷ lệ của nhiều danh mục với một chiều nhất định dưới dạng tỷ lệ phần trăm
...
Một tập dữ liệu tổng hợp tuân thủ đặc tả TidyData được dùng để xác định nguồn dữ liệu và cấu trúc của biểu đồ. Tập dữ liệu do người dùng nhập vào không yêu cầu bất kỳ xử lý nào. VSeed có chức năng định hình lại dữ liệu mạnh mẽ và sẽ tự định hình lại dữ liệu. Dữ liệu của biểu đồ phần trăm diện tích cuối cùng sẽ được chuyển đổi thành 2 chiều và 1 chỉ số.

:::

**Ví dụ**
```ts
[{tháng:'Tháng Một', danh mục:'A', giá trị:30}, {tháng:'Tháng Một', danh mục:'B', giá trị:70}]
...
Các chỉ số của biểu đồ diện tích phần trăm sẽ tự động được hợp nhất thành một chỉ số, được ánh xạ tới trục Y và tên chỉ số sẽ được hợp nhất với các thứ nguyên khác và hiển thị dưới dạng mục chú giải.
