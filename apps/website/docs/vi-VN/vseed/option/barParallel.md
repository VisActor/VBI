...
Biểu đồ thanh cạnh nhau hỗ trợ các kênh trực quan sau:
...
:::note{title="Mô tả"}
Biểu đồ thanh cạnh nhau phù hợp với kịch bản so sánh song song theo chiều ngang của nhiều chỉ số. Nhiều thanh được sắp xếp song song để hiển thị các giá trị chỉ số khác nhau.

Các tình huống áp dụng:

\-So sánh nhiều chỉ số khi tên danh mục dài

\-So sánh theo chiều ngang trong đó thứ hạng và giá trị được hiển thị cùng lúc
...
\- Thứ nguyên đầu tiên sẽ được đặt trên trục Y và các thứ nguyên còn lại sẽ được hợp nhất với tên chỉ số (khi có nhiều chỉ số) và hiển thị dưới dạng mục chú giải.

\- Tất cả các chỉ số sẽ được tự động hợp nhất thành một chỉ số

Các tính năng được bật theo mặc định:

\-Chú giải, trục, nhãn dữ liệu và thông tin nhắc nhở được bật theo mặc định.
...
:::note{title="Mô tả"}
Biểu đồ thanh cạnh nhau, phù hợp với kịch bản so sánh song song theo chiều ngang đa chỉ số
...
:::note{title="Mô tả"}
Nguồn dữ liệu, một tập dữ liệu tuân thủ các thông số kỹ thuật của TidyData và đã được tổng hợp, được sử dụng để xác định nguồn dữ liệu và cấu trúc của biểu đồ. Tập dữ liệu do người dùng nhập vào không yêu cầu bất kỳ xử lý nào. VSeed có chức năng định hình lại dữ liệu mạnh mẽ và sẽ tự định hình lại dữ liệu. Dữ liệu của biểu đồ thanh side-by-side cuối cùng sẽ được chuyển đổi thành 2 chiều và 1 chỉ số.
...
:::note{title="Mô tả"}
Thứ nguyên, thứ nguyên đầu tiên được ánh xạ tới trục Y và các thứ nguyên còn lại sẽ được hợp nhất với tên chỉ số (khi có nhiều chỉ số) và hiển thị dưới dạng mục chú giải.
...
:::note{title="Mô tả"}
Các chỉ số, chỉ số biểu đồ thanh cạnh nhau sẽ được tự động hợp nhất thành một chỉ số và ánh xạ tới trục X. Khi có nhiều chỉ số, tên chỉ số sẽ được hợp nhất với các thứ nguyên khác và hiển thị dưới dạng mục chú giải.

:::

**Ví dụ**
```ts
[{id: 'value1', bí danh: 'Indicator1'}, {id: 'value2', bí danh: 'Indicator2'}]
...
Cấu hình phân trang, được sử dụng để định cấu hình chức năng phân trang của biểu đồ
...
:::note{title="Mô tả"}
trục X, trục giá trị, cấu hình trục X, được sử dụng để xác định trục X của biểu đồ, bao gồm vị trí, định dạng, kiểu, v.v. của trục X.
...
:::note{title="Mô tả"}
trục Y, trục danh mục, cấu hình trục Y, được sử dụng để xác định trục Y của biểu đồ, bao gồm vị trí, định dạng, kiểu, v.v. của trục Y.
...
:::note{title="Mô tả"}
Cấu hình hộp nhắc ngang được sử dụng để xác định hộp nhắc ngang của biểu đồ, bao gồm màu sắc của hộp nhắc ngang, kiểu nhãn, v.v.
...
:::note{title="Mô tả"}
Biểu đồ thanh xếp chồng các góc tròn
...
:::note{title="Mô tả"}
Trong cùng một danh mục, khoảng cách giữa các hình chữ nhật có thể là giá trị pixel hoặc chuỗi phần trăm.
...
:::note{title="Mô tả"}
Cấu hình sắp xếp trục Y, hỗ trợ sắp xếp theo thứ nguyên hoặc chỉ số và thứ tự sắp xếp tùy chỉnh
...
:::note{title="Mô tả"}
Kiểu nguyên thủy hình chữ nhật, cấu hình kiểu biểu đồ thanh, được sử dụng để xác định kiểu biểu đồ thanh của biểu đồ, bao gồm màu biểu đồ thanh, đường viền, các góc tròn, v.v.
...
:::note{title="Mô tả"}
Các dòng nhãn số (bao gồm dòng trung bình, dòng giá trị lớn nhất, dòng giá trị nhỏ nhất, v.v.) được hiển thị theo hướng dọc. Vị trí và kiểu dáng của dòng nhãn có thể được đặt. Nếu bạn cần vẽ các dòng nhãn tương ứng với các giá trị như đường trung bình, vui lòng sử dụng cấu hình này.
...
:::note{title="Mô tả"}
Dòng nhãn giá trị kích thước, hiển thị theo chiều ngang, có thể thiết lập vị trí, kiểu dáng, v.v. của dòng nhãn
...
:::note{title="Mô tả"}
Cấu hình dòng nhãn khác biệt, được sử dụng để liên kết hai điểm neo dữ liệu và hiển thị chênh lệch tuyệt đối hoặc chênh lệch phần trăm.
...
:::note{title="Mô tả"}
Điểm neo bắt đầu của đường kích thước khác nhau.



Cấu hình điểm neo chú thích vi sai, được sử dụng để chọn dữ liệu được giới hạn bởi điểm bắt đầu hoặc điểm kết thúc.
...
:::note{title="Mô tả"}
Bộ chọn điểm neo cuối cùng phải được định vị ở một điểm neo hợp lý.
...
:::note{title="Mô tả"}
Điểm neo cuối cùng của đường kích thước vi sai.
...
:::note{title="Mô tả"}
Loại giá trị khác biệt

\- tuyệt đối: hiển thị chênh lệch tuyệt đối, được tính là kết thúc \- bắt đầu

\- phần trăm: Hiển thị chênh lệch phần trăm, được tính bằng (kết thúc \- bắt đầu) / bắt đầu
