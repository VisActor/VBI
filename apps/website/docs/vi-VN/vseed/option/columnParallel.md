...
Biểu đồ song song hỗ trợ các kênh hình ảnh sau:
...
:::note{title="Mô tả"}
Biểu đồ song song, thích hợp cho các kịch bản so sánh song song của nhiều chỉ số. Nhiều cột được sắp xếp cạnh nhau để hiển thị các giá trị chỉ số khác nhau.

Các tình huống áp dụng:

\- So sánh song song nhiều chỉ tiêu trong cùng một chiều
...
\-Chú giải, trục tọa độ, nhãn dữ liệu, thông tin nhắc nhở và sắp xếp chỉ số được bật theo mặc định.
...
:::note{title="Mô tả"}
Biểu đồ cạnh nhau, phù hợp với các kịch bản so sánh song song nhiều chỉ số
...
:::note{title="Mô tả"}
Tập dữ liệu, một tập dữ liệu tuân thủ các thông số kỹ thuật của TidyData và đã được tổng hợp, được sử dụng để xác định nguồn dữ liệu và cấu trúc của biểu đồ. Tập dữ liệu do người dùng nhập vào không yêu cầu bất kỳ xử lý nào. VSeed có chức năng định hình lại dữ liệu mạnh mẽ và sẽ tự định hình lại dữ liệu. Dữ liệu của biểu đồ song song cuối cùng sẽ được chuyển đổi thành 2 chiều và 1 chỉ số.
...
:::note{title="Mô tả"}
Thứ nguyên, thứ nguyên đầu tiên được ánh xạ tới trục X và các thứ nguyên còn lại sẽ được hợp nhất với tên chỉ số (khi có nhiều chỉ số) và hiển thị dưới dạng mục chú giải.
...
:::note{title="Mô tả"}
Các chỉ số, tất cả các chỉ số của biểu đồ cạnh nhau sẽ được tự động hợp nhất thành một chỉ số và ánh xạ tới trục Y. Khi có nhiều chỉ số, tên chỉ số sẽ được hợp nhất với các thứ nguyên khác và hiển thị dưới dạng mục chú giải.
...
:::note{title="Mô tả"}
Kiểu nguyên thủy hình chữ nhật, cấu hình kiểu biểu đồ cột song song, được sử dụng để xác định kiểu biểu đồ cột song song của biểu đồ, bao gồm màu sắc, đường viền, các góc tròn, v.v. của biểu đồ cột song song.
