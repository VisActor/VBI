...
:::note{title="Mô tả"}
Biểu đồ cột cuộc đua

Phù hợp hiển thị thứ hạng dữ liệu theo thời gian, với các cột được sắp xếp theo chiều dọc

Các tình huống áp dụng:

\- Khi tên mục dữ liệu dài

\- Cần so sánh trực quan kích thước số của các danh mục khác nhau và hiển thị sự thay đổi của chúng theo thời gian.

\- Hiển thị xu hướng của dữ liệu chuỗi thời gian và cập nhật động việc sắp xếp cột
...
\- trục X là trục danh mục (dữ liệu danh mục), hiển thị các giá trị thứ nguyên

\-trục Y là trục số (dữ liệu liên tục), hiển thị các giá trị chỉ số

\-Hỗ trợ kiểm soát kích thước thời gian thông qua trình phát và hiển thị động các thay đổi dữ liệu

\- Các cột được sắp xếp động theo giá trị số của chúng trong ảnh động
...
:::note{title="Mô tả"}
Biểu đồ động, phù hợp để hiển thị thứ hạng dữ liệu theo thời gian
...
:::note{title="Mô tả"}
Các bộ dữ liệu tuân thủ đặc tả TidyData và đã được tổng hợp
...
Thứ nguyên đầu tiên được ánh xạ tới người chơi và thứ nguyên thứ hai được ánh xạ tới trục X
...
Tất cả các chỉ số của biểu đồ động sẽ được tự động hợp nhất thành một chỉ số và ánh xạ tới trục Y. Khi có nhiều chỉ số, tên chỉ số sẽ được hợp nhất với các thứ nguyên khác và hiển thị dưới dạng mục chú giải.
...
:::note{title="Mô tả"}
Cấu hình trình phát, được sử dụng để chỉ định thứ nguyên thời gian, là cấu hình cốt lõi của biểu đồ động

Kiểm soát tiến trình phát lại theo chiều thời gian thông qua trình phát để đạt được các cập nhật động và sắp xếp các thay đổi dữ liệu
...
:::note{title="Mô tả"}
Cấu hình sắp xếp, biểu đồ động thường cần được sắp xếp động dựa trên các giá trị số

Kiểm soát cách sắp xếp các cột trên trục X
...
:::note{title="Mô tả"}
Cấu hình nhãn để hiển thị nhãn dữ liệu trên cột
...
:::note{title="Mô tả"}
Cấu hình trục X, là trục danh mục, hiển thị các giá trị thứ nguyên và các cột được sắp xếp theo chiều dọc
...
:::note{title="Mô tả"}
Cấu hình Crosshair để hiển thị giá trị chính xác của dữ liệu
...
:::note{title="Mô tả"}
Cấu hình phi lê xếp chồng lên nhau
...
:::note{title="Mô tả"}
Cấu hình kiểu cột, có thể là một kiểu hoặc một mảng
...
:::note{title="Mô tả"}
Dòng nhãn giá trị thứ nguyên, dòng nhãn ngang, đánh dấu danh mục trục Y cụ thể
...
:::note{title="Mô tả"}
Cấu hình liên kết thứ nguyên hỗ trợ tương tác liên kết thứ nguyên giữa nhiều biểu đồ
