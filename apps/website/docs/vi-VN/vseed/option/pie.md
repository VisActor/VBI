...
Biểu đồ hình tròn hỗ trợ các kênh hình ảnh sau:
...
:::note{title="Mô tả"}
Biểu đồ hình tròn phù hợp để hiển thị mối quan hệ tỷ lệ của dữ liệu một chiều. Tỷ trọng của mỗi hạng mục được thể hiện bằng quy mô của khu vực ngành.

Các tình huống áp dụng:

\- Hiển thị tỷ lệ phân bổ dữ liệu phân loại

\- Nhấn mạnh mối quan hệ giữa toàn bộ và các bộ phận của dữ liệu

\-Phân tích tỷ lệ của một số ít danh mục (khuyến nghị không quá 6)
...
\- Tất cả các chiều sẽ được gộp với tên chỉ số (khi có nhiều chỉ số) thành một chiều và hiển thị dưới dạng mục chú giải

\- Tất cả các chỉ số sẽ được tự động hợp nhất thành một chỉ số

Các tính năng được bật theo mặc định:

\-Chú giải, nhãn dữ liệu, thông tin nhắc nhở và tính toán tỷ lệ được bật theo mặc định.
...
Biểu đồ hình tròn, hiển thị mối quan hệ tỷ lệ của dữ liệu một chiều
...
Một tập dữ liệu tổng hợp tuân thủ đặc tả TidyData được dùng để xác định nguồn dữ liệu và cấu trúc của biểu đồ. Tập dữ liệu do người dùng nhập vào không yêu cầu bất kỳ xử lý nào. VSeed có chức năng định hình lại dữ liệu mạnh mẽ và sẽ tự định hình lại dữ liệu. Dữ liệu biểu đồ hình tròn cuối cùng sẽ được chuyển đổi thành 1 chiều và 1 chỉ số.
...
Tất cả các kích thước của biểu đồ hình tròn sẽ được kết hợp với tên chỉ số (khi có nhiều chỉ số) thành một thứ nguyên, ánh xạ tới góc và hiển thị dưới dạng mục chú giải
...
Tất cả các chỉ số của biểu đồ hình tròn sẽ tự động được hợp nhất thành một chỉ số và ánh xạ tới trục bán kính. Khi có nhiều chỉ số, tên chỉ số sẽ được hợp nhất với các kích thước còn lại và hiển thị dưới dạng mục chú giải.
