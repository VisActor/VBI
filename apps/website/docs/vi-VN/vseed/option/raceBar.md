...
Thích hợp để hiển thị các thay đổi xếp hạng trong dữ liệu theo thời gian
...
:::note{title="Mô tả"}
Biểu đồ thanh động, phù hợp hiển thị thứ hạng dữ liệu theo thời gian
...
\- player: hỗ trợ ánh xạ nhiều chiều tới các kênh phát lại
...
:::note{title="Mô tả"}
Cấu hình trình phát, được sử dụng để chỉ định kích thước thời gian, cấu hình cốt lõi của biểu đồ thanh động
...
:::note{title="Mô tả"}
Cấu hình sắp xếp, biểu đồ thanh động thường cần được sắp xếp động dựa trên các giá trị số
...
:::note{title="Mô tả"}
cấu hình trục X, là trục số và hiển thị các giá trị chỉ số
...
:::note{title="Mô tả"}
Cấu hình trục Y, là trục danh mục, hiển thị các giá trị thứ nguyên và các cột được sắp xếp theo chiều dọc
