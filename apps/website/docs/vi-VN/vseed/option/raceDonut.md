...
:::note{title="Mô tả"}
Biểu đồ bánh rán cuộc đua

Nó phù hợp để hiển thị mối quan hệ tỷ lệ của dữ liệu theo thời gian. Có một vùng trống ở giữa để hiển thị thông tin tóm tắt.

Các tình huống áp dụng:

\- Cần hiển thị cùng lúc dữ liệu tổng thể và sự thay đổi tỷ lệ của từng bộ phận theo thời gian
...
\- So với biểu đồ hình tròn, vùng trung tâm được để trống, nhìn nhẹ hơn
...
:::note{title="Mô tả"}
Biểu đồ bánh rán động, thích hợp để hiển thị mối quan hệ tỷ lệ thay đổi dữ liệu theo thời gian
...
:::note{title="Mô tả"}
Cấu hình trình phát, được sử dụng để chỉ định kích thước thời gian, cấu hình cốt lõi của biểu đồ bánh rán động
