...
:::note{title="Mô tả"}
Biểu đồ phân tán cuộc đua

Nó phù hợp để hiển thị phân bố dữ liệu theo thời gian và biểu thị giá trị của hai chỉ số thông qua vị trí của các điểm dữ liệu.

Các tình huống áp dụng:

\-Phân tích các đặc điểm phân bố của dữ liệu trong không gian hai chiều và hiển thị những thay đổi động của nó theo thời gian

\- Hiển thị sự phát triển của mối tương quan giữa nhiều biến theo thời gian
...
\- Cả trục X và trục Y đều là trục số (dữ liệu liên tục) và hỗ trợ nhiều ánh xạ chỉ số

\-Hỗ trợ kiểm soát kích thước thời gian thông qua trình phát và hiển thị động các thay đổi dữ liệu

\- Hiển thị trực quan sự thay đổi động của dữ liệu thông qua sự thay đổi vị trí của các điểm dữ liệu
...
:::note{title="Mô tả"}
Biểu đồ phân tán động, thích hợp để hiển thị phân bố dữ liệu theo thời gian
...
:::note{title="Mô tả"}
Nguồn dữ liệu, một tập dữ liệu tuân theo đặc tả TidyData
...
:::note{title="Mô tả"}
Kích thước, được sử dụng để phân biệt các chuỗi dữ liệu khác nhau và chú giải hiển thị
...
:::note{title="Mô tả"}
Các kênh để ánh xạ thứ nguyên trong biểu đồ lớp biểu đồ phân tán cạnh tranh
...
\- player: hỗ trợ ánh xạ nhiều chiều tới các kênh của trình phát
...
:::note{title="Mô tả"}
Các chỉ số, ít nhất 2 chỉ số cần được ánh xạ lần lượt vào trục X và trục Y
...
:::note{title="Mô tả"}
Cấu hình trình phát, được sử dụng để chỉ định thứ nguyên thời gian, là cấu hình cốt lõi của các biểu đồ phân tán động

Kiểm soát tiến trình phát lại theo chiều thời gian thông qua trình phát để đạt được cập nhật dữ liệu động
...
:::note{title="Mô tả"}
Cấu hình sắp xếp, được sử dụng để kiểm soát cách sắp xếp các giá trị thứ nguyên
...
:::note{title="Mô tả"}
Cấu hình phân trang, được sử dụng để xử lý các tình huống có lượng dữ liệu lớn
...
:::note{title="Mô tả"}
Cấu hình màu sắc để phân biệt các kích thước hoặc chỉ số khác nhau
...
:::note{title="Mô tả"}
Cấu hình nhãn để hiển thị nhãn dữ liệu trên các điểm dữ liệu
...
:::note{title="Mô tả"}
Cấu hình thông tin nhắc nhở, dùng để hiển thị thông tin chi tiết khi di chuột
...
:::note{title="Mô tả"}
Cấu hình lựa chọn khung, được sử dụng để hỗ trợ tương tác lựa chọn khung
...
:::note{title="Mô tả"}
Cấu hình trục X, là trục số, hiển thị giá trị chỉ số đầu tiên
...
:::note{title="Mô tả"}
Cấu hình trục Y, là trục số và hiển thị giá trị chỉ số thứ hai
...
:::note{title="Mô tả"}
Cấu hình Crosshair để hiển thị vị trí chính xác của dữ liệu
...
:::note{title="Mô tả"}
Cấu hình kiểu điểm dữ liệu, có thể ở dạng một kiểu hoặc một mảng và hỗ trợ kiểu toàn cục hoặc cấu hình kiểu có điều kiện.
...
:::note{title="Mô tả"}
Cấu hình điểm nhãn để thêm điểm đánh dấu trên các điểm dữ liệu cụ thể
...
:::note{title="Mô tả"}
Dòng nhãn số, dòng nhãn dọc, đánh dấu giá trị trục X cụ thể
...
:::note{title="Mô tả"}
Dòng nhãn số, dòng nhãn ngang, đánh dấu các giá trị trục Y cụ thể
...
:::note{title="Mô tả"}
Cấu hình vùng chú thích để làm nổi bật các phạm vi dữ liệu cụ thể
