...
Biểu đồ hỗ trợ các kênh hình ảnh sau:

`xAxis`: kênh trục X, hỗ trợ `một chiều`, được đánh dấu và tính theo giá trị thứ nguyên và hiển thị trên trục X

:::

:::note{title="Mô tả"}
Biểu đồ phù hợp với các kịch bản hiển thị phân phối dữ liệu. trục X là trục số (dữ liệu liên tục), trục Y là trục số (dữ liệu liên tục) và các cột được sắp xếp theo chiều dọc.

Các tình huống áp dụng:

\- Hiển thị phân phối dữ liệu, chẳng hạn như phân phối tần số, phân phối xác suất, v.v.

\-Phân tích xu hướng trung tâm và sự phân tán dữ liệu

\- Xác định các ngoại lệ và mẫu trong dữ liệu
...
:::note{title="Mô tả"}
Biểu đồ, thích hợp để hiển thị phân phối dữ liệu
...
:::note{title="Mô tả"}
Một tập dữ liệu tổng hợp tuân thủ đặc tả TidyData được dùng để xác định nguồn dữ liệu và cấu trúc của biểu đồ. Tập dữ liệu do người dùng nhập vào không yêu cầu bất kỳ xử lý nào. VSeed có chức năng định hình lại dữ liệu mạnh mẽ và sẽ tự định hình lại dữ liệu. Dữ liệu biểu đồ cuối cùng sẽ được chuyển đổi thành 2 chiều và 1 chỉ số.
...
:::note{title="Mô tả"}
Biểu đồ thường không yêu cầu kích thước
...
:::note{title="Mô tả"}
Biểu đồ chỉ hỗ trợ một chiều và dữ liệu là dữ liệu rời rạc
...
\- value: kênh giá trị của biểu đồ

\-x0: kênh x0 của biểu đồ

\-x1: kênh x1 của biểu đồ
...
:::note{title="Mô tả"}
Màu nền của biểu đồ. Màu nền có thể là một chuỗi màu. Mặc định là nền trong suốt, chẳng hạn như 'đỏ', 'xanh' hoặc có thể là hex, rgb hoặc rgba'#ff0000', 'rgba(255,0,0,0.5)'
...
:::note{title="Mô tả"}
Biểu đồ cột xếp chồng các góc bo tròn
...
:::note{title="Mô tả"}
Số phân nhóm biểu đồ, được sử dụng để xác định số lượng hình chữ nhật (cột) phân nhóm của biểu đồ.
...
:::note{title="Mô tả"}
Kích thước bước tạo thùng, được sử dụng để tính chiều rộng của thùng, cũng ảnh hưởng đến chiều rộng của hình chữ nhật (cột) trong biểu đồ cuối cùng. Nếu cả binCount và binStep đều được đặt thì binStep sẽ được ưu tiên.
...
:::note{title="Mô tả"}
Loại giá trị tạo nhóm biểu đồ, được sử dụng để xác định loại giá trị hình chữ nhật (cột) của biểu đồ, mặc định là 'đếm'
...
:::note{title="Mô tả"}
Kiểu nguyên thủy hình chữ nhật, cấu hình kiểu biểu đồ thanh, được sử dụng để xác định kiểu biểu đồ thanh của biểu đồ, bao gồm màu sắc của biểu đồ thanh, đường viền, góc tròn, v.v.
...
:::note{title="Mô tả"}
Các dòng nhãn số (giá trị gộp) được hiển thị theo hướng dọc. Vị trí và kiểu dáng của dòng nhãn có thể được đặt. Nếu bạn cần các dòng nhãn tương ứng với các giá trị tạo thùng, bạn có thể sử dụng cấu hình này.
...
:::note{title="Mô tả"}
Các dòng nhãn số (bao gồm dòng trung bình, dòng giá trị lớn nhất, dòng giá trị nhỏ nhất, v.v.) được hiển thị theo hướng ngang. Vị trí và kiểu dáng của dòng nhãn có thể được đặt. Nếu bạn cần vẽ đường nhãn tương ứng với giá trị tạo thùng, vui lòng sử dụng cấu hình này; lưu ý rằng giá trị tạo thùng bị ảnh hưởng bởi `binValueType`
...
:::note{title="Mô tả"}
Cấu hình đường hồi quy mật độ hạt nhân, được sử dụng để hiển thị xu hướng và phân phối dữ liệu
...
:::note{title="Mô tả"}
Có nên bật chức năng đường hồi quy hay không
...
:::note{title="Mô tả"}
Cấu hình đường hồi quy hàm phân phối tích lũy theo kinh nghiệm, được sử dụng để hiển thị phân phối tích lũy của dữ liệu
