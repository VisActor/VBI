...
Hiển thị phân phối doanh thu và lợi nhuận của các danh mục như thực phẩm và đồ uống, sản phẩm chăm sóc cá nhân và vệ sinh gia đình, đồng thời hiển thị các mối quan hệ phân cấp và chỉ số thông qua các vòng tròn nhiều lớp.
