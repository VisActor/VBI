...
Hiển thị doanh thu và phân bổ lợi nhuận của các danh mục như thực phẩm và đồ uống, chăm sóc cá nhân và đồ gia dụng, đồng thời hiển thị các mối quan hệ phân cấp và chỉ số thông qua việc lồng hình chữ nhật.
