...
| [pie-chart-measure-encoding](/VBI/vbi/examples/chartType.md#pie-chart-measure-encoding)         | 饼图度量编码 - 测试 measure-encoding.ts Pie 图表类型       | -    |
| [rose-by-city](/VBI/vbi/examples/chartType.md#rose-by-city)                                     | 玫瑰图 - 按城市销售额                                      | -    |
| [scatter-chart-measure-encoding](/VBI/vbi/examples/chartType.md#scatter-chart-measure-encoding) | 散点图度量编码 - 测试 measure-encoding.ts Scatter 图表类型 | -    |
...
| 示例                                                                              | 描述                                   | 标签 |
| --------------------------------------------------------------------------------- | -------------------------------------- | ---- |
| [add-date-dimension-year](/VBI/vbi/examples/dimensions.md#add-date-dimension-year)                   | 添加按年聚合的日期维度                 | -    |
...
| [mixed-date-and-normal-dimensions](/VBI/vbi/examples/dimensions.md#mixed-date-and-normal-dimensions) | 普通维度与按季度聚合的日期维度混合分组 | -    |
| [remove-dimension](/VBI/vbi/examples/dimensions.md#remove-dimension)                                 | 删除维度                               | -    |
| [update-date-dimension-month](/VBI/vbi/examples/dimensions.md#update-date-dimension-month)           | 将已有日期维度更新为按月聚合           | -    |
...
| [having-array-value-with-in-operator](/VBI/vbi/examples/havingFilter.md#having-array-value-with-in-operator)                 | Having filter with array value that triggers 'in' operator conversion                                                                | -    |
| [having-array-value-with-not-in-operator](/VBI/vbi/examples/havingFilter.md#having-array-value-with-not-in-operator)         | Having filter with array value that triggers 'not in' operator conversion                                                            | -    |
...
| [having-empty-dsl-compose-target](/VBI/vbi/examples/havingFilter.md#having-empty-dsl-compose-target)                         | 从空DSL出发，通过builder拼装where/having/measures/dimensions，包含sum与countDistinct聚合的having条件组合                             | -    |
| [having-field-not-in-measures-and-dimensions](/VBI/vbi/examples/havingFilter.md#having-field-not-in-measures-and-dimensions) | 初始化空DSL，仅通过builder添加维度area与指标sales，并在having中使用未出现在measures/dimensions里的profit字段（SUM(profit) > 100000） | -    |
...
| [measure-with-custom-and-auto-format](/VBI/vbi/examples/measures.md#measure-with-custom-and-auto-format) | 度量格式化：销售额使用万元自定义格式（¥前缀、保留2位小数），利润率使用自动格式化，折扣使用百分比格式 | -    |
...
| [date-filter-period-and-range-combo](/VBI/vbi/examples/whereFilter.md#date-filter-period-and-range-combo)                   | 日期区间组合过滤：使用 period 筛选2024年Q1数据，同时用 range 限定利润区间，按品类和配送方式交叉分析 | -    |
| [date-filter-relative-with-nested-conditions](/VBI/vbi/examples/whereFilter.md#date-filter-relative-with-nested-conditions) | 日期过滤与嵌套条件组合：筛选近30天内消费者或企业客户的高额订单，按省份统计销售额与利润              | -    |
...
| [not-between-sales-range](/VBI/vbi/examples/whereFilter.md#not-between-sales-range)                                         | Not between filter: exclude sales between 1000~10000                                                | -    |
| [not-between-with-explicit-operators](/VBI/vbi/examples/whereFilter.md#not-between-with-explicit-operators)                 | Not between filter with explicit leftOp/rightOp to test invert functions                            | -    |
...
| [where-filter-array-value-converts-to-in](/VBI/vbi/examples/whereFilter.md#where-filter-array-value-converts-to-in)         | Where filter with array value using '=' operator should convert to 'in'                             | -    |
| [where-filter-array-value-converts-to-not-in](/VBI/vbi/examples/whereFilter.md#where-filter-array-value-converts-to-not-in) | Where filter with array value using '!=' operator should convert to 'not in'                        | -    |
