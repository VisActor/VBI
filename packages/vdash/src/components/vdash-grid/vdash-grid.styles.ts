...
const gridstackStyles = css`
  ...
  .grid-stack-placeholder > .placeholder-content {
    background-color: var(--vdash-grid-placeholder-bg, rgba(0, 0, 0, 0.1));
    margin: 0;
    position: absolute;
    width: auto;
    z-index: 0 !important;
  ...
  .ui-resizable-resizing > .grid-stack-item-content {
    box-shadow: var(--vdash-grid-drag-shadow, 1px 4px 6px rgba(0, 0, 0, 0.2));
    opacity: var(--vdash-grid-drag-opacity, 0.8);
  }
...
const styles: CSSResultGroup = [
  ...
  css`
    ...
    .slot-fallback {
      align-items: center;
      color: var(--vdash-grid-fallback-color, #64748b);
      display: flex;
      font-size: 12px;
      height: 100%;
